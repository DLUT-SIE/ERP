...
^^^^^^^
    ...
    :get:`GET` :code:`/api/production_workgroups/`
...
^^^^^^^^^
    ...
    :get:`GET` :code:`/api/production_workgroups/{id}/`
...
^^^^^^^^^^^^^^^^
    ...
    :patch:`PATCH` :code:`/api/production_workgroups/{id}/`
...
^^^^^^^^
    ...
    :post:`POST` :code:`/api/production_workgroups/`
