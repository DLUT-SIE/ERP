...
APPLYCARD_STATUS_CHOICES = (
    (APPLYCARD_STATUS_APPLICANT, '领用已创建'),
    (APPLYCARD_STATUS_AUDITOR, '领用已审核'),
    (APPLYCARD_STATUS_INSPECTOR, '领用已检查'),
    (APPLYCARD_STATUS_KEEPER, '领用已发料'),
    (APPLYCARD_STATUS_END, '领用已完成'),
    (APPLYCARD_STATUS_STOP, '领用已终止'),
)
