...
var _modules = __webpack_require__(956);

var _StatusHistory = __webpack_require__(1605);

var _StatusHistory2 = _interopRequireDefault(_StatusHistory);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_StatusHistory2.default));
...
var columns = ['pretty_original_status', 'pretty_new_status', 'change_dt', 'change_user', 'change_type', 'reason_bidding_sheet'];

var StatusHistory = function (_React$Component) {
  (0, _inherits3.default)(StatusHistory, _React$Component);

  function StatusHistory(props) {
    (0, _classCallCheck3.default)(this, StatusHistory);

    var _this = (0, _possibleConstructorReturn3.default)(this, (StatusHistory.__proto__ || (0, _getPrototypeOf2.default)(StatusHistory)).call(this, props));
  ...
  (0, _createClass3.default)(StatusHistory, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function buildColumns() {
      return _utils2.default.buildColumns(columns, {
        ...
        change_type: {
          render: function render(text, record, index) {
            return record.normal_change ? _react2.default.createElement(
              'span',
              { className: 'normal-change' },
              '\u6B63\u5E38\u66F4\u6539'
            ) : _react2.default.createElement(
              'span',
              { className: 'force-change' },
              '\u5F3A\u5236\u66F4\u6539'
            );
          }
        }
...
var STATUSHISTORY_GET_LIST_DATA = 'STATUSHISTORY_GET_LIST_DATA';
var STATUSHISTORY_ADD_LIST_DATA = 'STATUSHISTORY_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function StatusHistory() {
  ...
  var map = {
    STATUSHISTORY_GET_LIST_DATA: function STATUSHISTORY_GET_LIST_DATA() {
    ...
    STATUSHISTORY_ADD_LIST_DATA: function STATUSHISTORY_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(STATUSHISTORY_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getStatusChanges, params);
