...
var _modules = __webpack_require__(952);

var _PurchaseOrderManagement = __webpack_require__(1598);

var _PurchaseOrderManagement2 = _interopRequireDefault(_PurchaseOrderManagement);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PurchaseOrderManagement2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('status', { initialValue: 0 })(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u8BF7\u9009\u62E9\u8BA2\u8D2D\u5355\u72B6\u6001',
            list: _const.PURCHASE_ORDER_STATUS_LIST
          }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u8BA2\u8D2D\u5355\u5355\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _FilterBar = __webpack_require__(1597);
...
var columns = ['purchase_order_uid', 'purchase_order_create_dt', 'action'];

var PurchaseOrderManagement = function (_React$Component) {
  (0, _inherits3.default)(PurchaseOrderManagement, _React$Component);

  function PurchaseOrderManagement(props) {
    (0, _classCallCheck3.default)(this, PurchaseOrderManagement);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PurchaseOrderManagement.__proto__ || (0, _getPrototypeOf2.default)(PurchaseOrderManagement)).call(this, props));
    ...
    _this.handleFinishPurchaseOrder = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updatePurchaseOrder, {}, { id: id }).then(function (repos) {
  ...
  (0, _createClass3.default)(PurchaseOrderManagement, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { to: '/purchase/purchase_order_management/purchase_order/?purchase_order=' + record.id + '&status=' + record.status },
                  '\u67E5\u770B'
                )
              ),
              ...
              record.status === 1 && _react2.default.createElement(
                _popconfirm2.default,
                {
                  title: '\u786E\u5B9A\u5B8C\u6210\u8BE5\u8BA2\u8D2D\u5355\u5417\uFF1F',
                  onConfirm: _this2.handleFinishPurchaseOrder(record.id),
                  okText: '\u786E\u5B9A',
                  cancelText: '\u53D6\u6D88'
                },
                _react2.default.createElement(
...
exports.default = PurchaseOrderManagement;
...
var PURCHASEORDERMANAG_GET_LIST_DATA = 'PURCHASEORDERMANAG_GET_LIST_DATA';
var PURCHASEORDERMANAG_ADD_LIST_DATA = 'PURCHASEORDERMANAG_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function PurchaseOrderManagement() {
  ...
  var map = {
    PURCHASEORDERMANAG_GET_LIST_DATA: function PURCHASEORDERMANAG_GET_LIST_DATA() {
    ...
    PURCHASEORDERMANAG_ADD_LIST_DATA: function PURCHASEORDERMANAG_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PURCHASEORDERMANAG_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getPurchaseOrders, params);
