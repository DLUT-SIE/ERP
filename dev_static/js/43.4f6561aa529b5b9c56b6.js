...
var _modules = __webpack_require__(954);

var _Quotation = __webpack_require__(1601);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Quotation2.default));
...
var _QuotationModal = __webpack_require__(1602);
...
var columns = ['pretty_inventory_type', 'name_spec', 'material_mark_quotation', 'unit_price', 'unit', 'action'];

var Quotation = function (_React$Component) {
  (0, _inherits3.default)(Quotation, _React$Component);

  function Quotation(props) {
    (0, _classCallCheck3.default)(this, Quotation);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Quotation.__proto__ || (0, _getPrototypeOf2.default)(Quotation)).call(this, props));
    ...
    _this.handleSaveQuotation = function (id, fieldsValue) {
      if (_lodash2.default.isUndefined(id)) {
        (0, _api2.default)(_config.apis.PurchaseAPI.addSupplierQuotation, (0, _extends3.default)({}, fieldsValue, {
          supplier: _this._id
        })).then(function (repos) {
        ...
        (0, _api2.default)(_config.apis.PurchaseAPI.updateSupplierQuotation, fieldsValue, { id: id }).then(function (repos) {
          _message5.default.success('编辑成功！');
          _this.handleCloseModal();
          _this.updatelist();
        });
      }
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.deleteSupplierQuotation, {}, { id: id }).then(function (repos) {
    ...
    _this._id = +query.id;
    _this._uid = +query.uid;
    _this._columns = _this.buildColumns();
    return _this;
  }

  (0, _createClass3.default)(Quotation, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_QuotationModal2.default, (0, _extends3.default)({}, modal, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u7269\u6599\u7C7B\u578B' }, formItemLayout),
                getFieldDecorator('inventory_type', fieldsConfig['inventory_type'])(_react2.default.createElement(_CustomSelect2.default, {
                  placeholder: '\u8BF7\u9009\u62E9\u7269\u6599\u7C7B\u578B',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u89C4\u683C\u53CA\u540D\u79F0' }, formItemLayout),
                getFieldDecorator('name_spec', fieldsConfig['name_spec'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u89C4\u683C\u53CA\u540D\u79F0' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                ...
                getFieldDecorator('material_mark', fieldsConfig['material_mark'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6750\u8D28' }))
              )
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u5355\u4EF7' }, formItemLayout),
                getFieldDecorator('unit_price', fieldsConfig['unit_price'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u5355\u4EF7' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
...
var QUOTATION_GET_LIST_DATA = 'QUOTATION_GET_LIST_DATA';
var QUOTATION_ADD_LIST_DATA = 'QUOTATION_ADD_LIST_DATA';
var QUOTATION_CHANGE_MODAL = 'QUOTATION_CHANGE_MODAL';
var PAGE_SIZE = 10;
...
function Quotation() {
  ...
  var map = {
    QUOTATION_GET_LIST_DATA: function QUOTATION_GET_LIST_DATA() {
    ...
    QUOTATION_ADD_LIST_DATA: function QUOTATION_ADD_LIST_DATA() {
    ...
    QUOTATION_CHANGE_MODAL: function QUOTATION_CHANGE_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(QUOTATION_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getSupplierQuotations, params);
