...
var _modules = __webpack_require__(939);

var _CheckoutEntry = __webpack_require__(1560);

var _CheckoutEntry2 = _interopRequireDefault(_CheckoutEntry);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CheckoutEntry2.default));
...
var _message5 = __webpack_require__(29);
...
var columns0 = ['selected', 'name_order', 'spec_order', 'material_order', 'count_order', 'total_weight_order', 'material_confirm', 'soft_confirm', 'inspection_confirm'];
var columns1 = ['selected', 'name_order', 'material_order', 'drawing_number_order', 'count_order', 'material_confirm', 'soft_confirm', 'inspection_confirm'];
var columns2 = ['selected', 'name_order', 'material_order', 'spec_order', 'material_confirm', 'soft_confirm', 'inspection_confirm'];

var CheckoutEntry = function (_React$Component) {
  (0, _inherits3.default)(CheckoutEntry, _React$Component);

  function CheckoutEntry(props) {
    (0, _classCallCheck3.default)(this, CheckoutEntry);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CheckoutEntry.__proto__ || (0, _getPrototypeOf2.default)(CheckoutEntry)).call(this, props));
    ...
    _this.handleMaterialConfirm = function (e) {
      var id = e.target.dataset.id;

      (0, _api2.default)(_config.apis.PurchaseAPI.updateArrivalInspections, { material_confirm: true }, { id: +id }).then(function () {
        _message6.default.success('修改成功！');
        _this.updatelist();
      });
    };

    _this.handleSoftConfirm = function (e) {
      var id = e.target.dataset.id;

      (0, _api2.default)(_config.apis.PurchaseAPI.updateArrivalInspections, { soft_confirm: true }, { id: +id }).then(function () {
        _message6.default.success('修改成功！');
        _this.updatelist();
      });
    };

    _this.handleInspectionConfirm = function (e) {
      var id = e.target.dataset.id;

      (0, _api2.default)(_config.apis.PurchaseAPI.updateArrivalInspections, { inspection_confirm: true }, { id: +id }).then(function () {
        _message6.default.success('修改成功！');
        _this.updatelist();
      });
    };

    _this.handleCreateEntry = function () {};

    _this.handleFinishBid = function () {
      (0, _api2.default)(_config.apis.PurchaseAPI.updateBiddingSheet, { status: 9 }, { id: _this._id }).then(function () {
        _message6.default.success('状态修改成功！');
    ...
    _this._id = +query.id;
    _this._status = +query.status;
    _this._columns = _this.buildColumns();
    return _this;
  }

  (0, _createClass3.default)(CheckoutEntry, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;
      ...
      this.props.getBidDataAction({
        id: this._id,
        callback: function callback(bid) {
          _this2.props.getOrderDataAction({
            id: bid.purchase_order,
            callback: function callback(order) {
              var clm = void 0;
              if (order.category === 0) {
                clm = columns0;
              ...
              var columns = _this2.buildColumns(clm);
              _this2.props.addOrderDataAction({ data: order, columns: columns });
            }
          });
        }
      });
    ...
    key: 'fetchListData',
    value: function fetchListData(query) {
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                'data-id': record.id,
                onClick: _this3.handleMaterialConfirm
              },
              '\u5B9E\u7269'
            );
          }
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                'data-id': record.id,
                onClick: _this3.handleSoftConfirm
              },
              '\u8F6F\u4EF6'
            );
          }
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                'data-id': record.id,
                onClick: _this3.handleInspectionConfirm
              },
              '\u68C0\u9A8C'
            );
          }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        bid.status === 8 && _react2.default.createElement(
          'div',
...
CheckoutEntry.propTypes = {
  ...
  getOrderDataAction: _propTypes2.default.func.isRequired,
  addOrderDataAction: _propTypes2.default.func.isRequired
};

exports.default = CheckoutEntry;
...
exports.getOrderSaga = getOrderSaga;
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(getListSaga),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(getBidSaga),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(getOrderSaga);

// ------------------------------------
// Constants
// ------------------------------------

var CHECKOUTENTRY_GET_LIST_DATA = 'CHECKOUTENTRY_GET_LIST_DATA';
var CHECKOUTENTRY_ADD_LIST_DATA = 'CHECKOUTENTRY_ADD_LIST_DATA';
var CHECKOUTENTRY_GET_BID_DATA = 'CHECKOUTENTRY_GET_BID_DATA';
var CHECKOUTENTRY_ADD_BID_DATA = 'CHECKOUTENTRY_ADD_BID_DATA';
var CHECKOUTENTRY_GET_ORDER_DATA = 'CHECKOUTENTRY_GET_ORDER_DATA';
var CHECKOUTENTRY_ADD_ORDER_DATA = 'CHECKOUTENTRY_ADD_ORDER_DATA';
var PAGE_SIZE = 10;
...
var actions = exports.actions = {
  ...
  getOrderDataAction: getOrderDataAction,
  addOrderDataAction: addOrderDataAction
...
function CheckoutEntry() {
  ...
  var map = {
    CHECKOUTENTRY_GET_LIST_DATA: function CHECKOUTENTRY_GET_LIST_DATA() {
    ...
    CHECKOUTENTRY_ADD_LIST_DATA: function CHECKOUTENTRY_ADD_LIST_DATA() {
    ...
    CHECKOUTENTRY_ADD_BID_DATA: function CHECKOUTENTRY_ADD_BID_DATA() {
      var data = action.payload.data;
    ...
    CHECKOUTENTRY_ADD_ORDER_DATA: function CHECKOUTENTRY_ADD_ORDER_DATA() {
      ...
      if (!_lodash2.default.isUndefined(columns)) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(CHECKOUTENTRY_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getArrivalInspections, params);
...
function getBidSaga(type, body) {
  var _ref2, _ref2$payload, _payload, _callback, id, data;

  return _regenerator2.default.wrap(function getBidSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(CHECKOUTENTRY_GET_BID_DATA);

        case 3:
          _ref2 = _context2.sent;
          _ref2$payload = _ref2.payload;
          _payload = _ref2$payload === undefined ? {} : _ref2$payload;
          _callback = _payload.callback, id = _payload.id;
          _context2.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getBiddingSheet, {}, { id: id });
...
function getOrderSaga(type, body) {
  var _ref3, _ref3$payload, _payload2, _callback2, _id, data;

  return _regenerator2.default.wrap(function getOrderSaga$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _effects.take)(CHECKOUTENTRY_GET_ORDER_DATA);

        case 3:
          _ref3 = _context3.sent;
          _ref3$payload = _ref3.payload;
          _payload2 = _ref3$payload === undefined ? {} : _ref3$payload;
          _callback2 = _payload2.callback, _id = _payload2.id;
          _context3.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getPurchaseOrder, {}, { id: _id });
        ...
        case 9:
          ...
          _context3.next = 13;
          return (0, _effects.put)(addOrderDataAction({ data: data }));
...
var sagas = exports.sagas = [getListSaga, getBidSaga, getOrderSaga];
