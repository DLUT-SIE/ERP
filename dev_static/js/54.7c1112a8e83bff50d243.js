...
var _modules = __webpack_require__(925);

var _MaterialApplyCard = __webpack_require__(1521);

var _MaterialApplyCard2 = _interopRequireDefault(_MaterialApplyCard);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_MaterialApplyCard2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u9886\u7528\u5355\u7F16\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('category', {
            ...
            rules: [{ required: true, message: '请选择材料类型' }] })(_react2.default.createElement(_CustomSelect2.default, { list: _const.MATERIAL_APPLY_CARD, placeholder: '\u8BF7\u9009\u62E9\u6750\u6599\u7C7B\u578B' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { to: '/production/material_apply_card/create_material_apply_card' },
              '\u6DFB\u52A0\u9886\u7528\u6750\u6599'
            )
          )
        )
...
var makeFields = function makeFields(fieldsValue) {
  ...
  _lodash2.default.forEach(fieldsValue, function (value, key) {
    ...
    if (key === 'category' && _lodash2.default.isNull(value)) {
      result[key] = _form2.default.createFormField({ value: 'welding_material_apply_cards' });
    }
  });
  return result;
};
...
var _FilterBar = __webpack_require__(1520);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _MaterialApplyCardModal = __webpack_require__(1522);

var _MaterialApplyCardModal2 = _interopRequireDefault(_MaterialApplyCardModal);
...
var columns = ['common_uid', 'sub_order_uid', 'department', 'create_dt', 'apply_card_pretty_status', 'action'];
var mapRequest = {
  welding_material_apply_cards: _config.apis.ProductionAPI.getWeldingMaterialApplyCardDetails,
  steel_material_apply_cards: _config.apis.ProductionAPI.getSteelMaterialApplyCardDetails,
  bought_in_component_apply_cards: _config.apis.ProductionAPI.getBroughtInMaterialApplyCardDetails,
  auxiliary_material_apply_cards: _config.apis.ProductionAPI.getAuxiliaryMaterialApplyCardDetails
};
var updateMapRequest = {
  welding_material_apply_cards: _config.apis.ProductionAPI.updateWeldingMaterialApplyCardsStatus,
  steel_material_apply_cards: _config.apis.ProductionAPI.updateSteelMaterialApplyCardsStatus,
  bought_in_component_apply_cards: _config.apis.ProductionAPI.updateBroughtInMaterialApplyCardsStatus,
  auxiliary_material_apply_cards: _config.apis.ProductionAPI.updateAuxiliaryMaterialApplyCardsStatus
};
  ...
  (0, _createClass3.default)(MaterialApplyCard, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_MaterialApplyCardModal2.default, (0, _extends3.default)({
...
var _WeldMaterialApplyCardTable = __webpack_require__(380);

var _WeldMaterialApplyCardTable2 = _interopRequireDefault(_WeldMaterialApplyCardTable);

var _SteelMaterialApplyCardTable = __webpack_require__(379);

var _SteelMaterialApplyCardTable2 = _interopRequireDefault(_SteelMaterialApplyCardTable);

var _BroughtInMaterialApplyCardTable = __webpack_require__(378);

var _BroughtInMaterialApplyCardTable2 = _interopRequireDefault(_BroughtInMaterialApplyCardTable);

var _AuxiliaryMaterialApplyCardTable = __webpack_require__(377);

var _AuxiliaryMaterialApplyCardTable2 = _interopRequireDefault(_AuxiliaryMaterialApplyCardTable);

var _const = __webpack_require__(50);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MaterialApplyCardModal = function (_React$Component) {
  (0, _inherits3.default)(MaterialApplyCardModal, _React$Component);

  function MaterialApplyCardModal(props) {
    (0, _classCallCheck3.default)(this, MaterialApplyCardModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MaterialApplyCardModal.__proto__ || (0, _getPrototypeOf2.default)(MaterialApplyCardModal)).call(this, props));

    _this.state = {};
    return _this;
  }

  (0, _createClass3.default)(MaterialApplyCardModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.category === _const.MATERIAL_APPLY_CARD_TYPE.WELD ? _react2.default.createElement(_WeldMaterialApplyCardTable2.default, { details: this.props.details, changeStatus: this.props.changeStatus }) : '',
          this.props.category === _const.MATERIAL_APPLY_CARD_TYPE.STEEL ? _react2.default.createElement(_SteelMaterialApplyCardTable2.default, { details: this.props.details, changeStatus: this.props.changeStatus }) : '',
          this.props.category === _const.MATERIAL_APPLY_CARD_TYPE.BROUGHT_IN ? _react2.default.createElement(_BroughtInMaterialApplyCardTable2.default, { details: this.props.details, changeStatus: this.props.changeStatus }) : '',
          this.props.category === _const.MATERIAL_APPLY_CARD_TYPE.AUXILIARY ? _react2.default.createElement(_AuxiliaryMaterialApplyCardTable2.default, { details: this.props.details, changeStatus: this.props.changeStatus }) : ''
        )
      );
    }
  }]);
  return MaterialApplyCardModal;
}(_react2.default.Component); /**
...
var APPLY_CARD_GET_LIST_DATA = 'APPLY_CARD_GET_LIST_DATA';
var APPLY_CARD_ADD_LIST_DATA = 'APPLY_CARD_ADD_LIST_DATA';
var APPLY_CARD_CHANGE_MODAL_DATA = 'APPLY_CARD_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function ApplyCard() {
  ...
  var map = {
    APPLY_CARD_GET_LIST_DATA: function APPLY_CARD_GET_LIST_DATA() {
    ...
    APPLY_CARD_ADD_LIST_DATA: function APPLY_CARD_ADD_LIST_DATA() {
    ...
    APPLY_CARD_CHANGE_MODAL_DATA: function APPLY_CARD_CHANGE_MODAL_DATA() {
...
// ------------------------------------
var mapRequest = {
  welding_material_apply_cards: _config.apis.ProductionAPI.getWeldingMaterialApplyCards,
  steel_material_apply_cards: _config.apis.ProductionAPI.getSteelMaterialApplyCards,
  bought_in_component_apply_cards: _config.apis.ProductionAPI.getBroughtInMaterialApplyCards,
  auxiliary_material_apply_cards: _config.apis.ProductionAPI.getAuxiliaryMaterialApplyCards
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(APPLY_CARD_GET_LIST_DATA);
        ...
        case 3:
          ...
          if (_lodash2.default.isUndefined(category)) {
            category = _config.apis.ProductionAPI.getWeldingMaterialApplyCards;
          }
          _context.next = 11;
