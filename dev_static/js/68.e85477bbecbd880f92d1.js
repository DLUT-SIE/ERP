...
var _modules = __webpack_require__(943);

var _EntryConfirm = __webpack_require__(1565);

var _EntryConfirm2 = _interopRequireDefault(_EntryConfirm);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_EntryConfirm2.default));
...
var _FilterBar = __webpack_require__(1566);
...
var columns = ['entry_form_uid', 'create_dt', 'purchaser', 'action'];
var typeMap = {
  0: {
    api: 'getWeldEntry',
    path: 'weld_entry'
...
var EntryConfirm = function (_React$Component) {
  (0, _inherits3.default)(EntryConfirm, _React$Component);

  function EntryConfirm(props) {
    (0, _classCallCheck3.default)(this, EntryConfirm);

    var _this = (0, _possibleConstructorReturn3.default)(this, (EntryConfirm.__proto__ || (0, _getPrototypeOf2.default)(EntryConfirm)).call(this, props));
  ...
  (0, _createClass3.default)(EntryConfirm, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var query = _queryString2.default.parse(this.props.location.search);
      if (!_lodash2.default.isUndefined(query.type)) {
        this.props.getListDataAction({
          api: typeMap[query.type].api,
          callback: function callback(data) {
            var columns = _this2.buildColumns(query);
            _this2.props.addListDataAction({ data: data, columns: columns });
          }
        });
      }
    }
    ...
    key: 'buildColumns',
    value: function buildColumns(query) {
      var path = typeMap[query.type].path;
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { to: '/purchase/entry_confirm/' + path + '/?id=' + record.id },
                '\u5F85\u5904\u7406'
              )
            );
          }
    ...
    value: function updatelist() {
      ...
      if (!_lodash2.default.isUndefined(query.type)) {
        this.props.getListDataAction({
          api: typeMap[query.type].api,
          callback: function callback(data) {
            var columns = _this3.buildColumns(query);
            _this3.props.addListDataAction({ data: data, columns: columns });
          }
        });
      }
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('type')(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u5165\u5E93\u5355\u7C7B\u522B',
            list: _const.MATERIAL_CATEGORY
          }))
        ),
        _react2.default.createElement(
          FormItem,
...
var ENTRYCONFIRM_GET_LIST_DATA = 'ENTRYCONFIRM_GET_LIST_DATA';
var ENTRYCONFIRM_ADD_LIST_DATA = 'ENTRYCONFIRM_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function EntryConfirm() {
  ...
  var map = {
    ENTRYCONFIRM_GET_LIST_DATA: function ENTRYCONFIRM_GET_LIST_DATA() {
    ...
    ENTRYCONFIRM_ADD_LIST_DATA: function ENTRYCONFIRM_ADD_LIST_DATA() {
...
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, api, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(ENTRYCONFIRM_GET_LIST_DATA);

        case 3:
          _ref = _context.sent;
          _ref$payload = _ref.payload;
          payload = _ref$payload === undefined ? {} : _ref$payload;
          callback = payload.callback, params = payload.params, api = payload.api;
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.InventoryAPI[api], params);
