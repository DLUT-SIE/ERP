...
var _modules = __webpack_require__(937);

var _BroughtInEntry = __webpack_require__(1553);

var _BroughtInEntry2 = _interopRequireDefault(_BroughtInEntry);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_BroughtInEntry2.default));
...
var _BroughtInEntryDetailTr = __webpack_require__(1554);

var _BroughtInEntryDetailTr2 = _interopRequireDefault(_BroughtInEntryDetailTr);

var _DetailModal = __webpack_require__(1555);
...
var BroughtInEntry = function (_React$Component) {
  (0, _inherits3.default)(BroughtInEntry, _React$Component);

  function BroughtInEntry(props) {
    (0, _classCallCheck3.default)(this, BroughtInEntry);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BroughtInEntry.__proto__ || (0, _getPrototypeOf2.default)(BroughtInEntry)).call(this, props));
    ...
    _this.handleSave = function (id, fieldsValue) {
      (0, _api2.default)(_config.apis.PurchaseAPI.updateBoughtInComponentEntryDetail, fieldsValue, { id: id }).then(function (repos) {
  ...
  (0, _createClass3.default)(BroughtInEntry, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _lodash2.default.map(data.details, function (item, index) {
              return _react2.default.createElement(_BroughtInEntryDetailTr2.default, {
                key: index,
                isBar: isBar,
                index: index,
                item: item,
...
exports.default = BroughtInEntry;
...
var BroughtInEntryDetailTr = function (_React$Component) {
  (0, _inherits3.default)(BroughtInEntryDetailTr, _React$Component);

  function BroughtInEntryDetailTr(props) {
    (0, _classCallCheck3.default)(this, BroughtInEntryDetailTr);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BroughtInEntryDetailTr.__proto__ || (0, _getPrototypeOf2.default)(BroughtInEntryDetailTr)).call(this, props));
  ...
  (0, _createClass3.default)(BroughtInEntryDetailTr, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          item = _props.item,
...
exports.default = BroughtInEntryDetailTr;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u7194\u70BC\u53F7' }, formItemLayout),
                getFieldDecorator('smelt_number', fieldsConfig['smelt_number'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u7194\u70BC\u53F7' }))
              )
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u751F\u4EA7\u5382\u5BB6' }, formItemLayout),
                getFieldDecorator('factory', fieldsConfig['factory'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u751F\u4EA7\u5382\u5BB6' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u51C0\u91CD' }, formItemLayout),
                getFieldDecorator('weight', fieldsConfig['weight'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u51C0\u91CD' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
...
var BROUTHTINENTRY_GET_DATA = 'BROUTHTINENTRY_GET_DATA';
var BROUTHTINENTRY_ADD_DATA = 'BROUTHTINENTRY_ADD_DATA';
var BROUTHTINENTRY_CHANGE_MODAL = 'BROUTHTINENTRY_CHANGE_MODAL';
...
function BroughtInEntry() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    BROUTHTINENTRY_ADD_DATA: function BROUTHTINENTRY_ADD_DATA() {
    ...
    BROUTHTINENTRY_CHANGE_MODAL: function BROUTHTINENTRY_CHANGE_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(BROUTHTINENTRY_GET_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getBoughtInComponentEntry, params, { id: id });
