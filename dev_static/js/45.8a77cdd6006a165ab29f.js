...
var _modules = __webpack_require__(933);

var _TaskConfirm = __webpack_require__(1542);

var _TaskConfirm2 = _interopRequireDefault(_TaskConfirm);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TaskConfirm2.default));
  ...
  function FilterBar(props) {
    ...
    _this.handleSubmit = function (e) {
      ...
      form.validateFields(function () {
        ...
        fieldsValue.plan_status = _utils2.default.str2bool(fieldsValue.plan_status);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('material_index')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5DE5\u4F5C\u7968\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('process_name')(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u5DE5\u5E8F',
            list: _index.PROCESS_ROUTE_LIST
          }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('production_workgroup')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u64CD\u4F5C\u7EC4' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('plan_status')(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u4EFB\u52A1\u8BA1\u5212\u72B6\u6001',
            list: _index.TASK_PLAN_STATUS
          }))
        ),
        _react2.default.createElement(
          FormItem,
...
var _FilterBar = __webpack_require__(1541);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _TaskConfirmModal = __webpack_require__(1543);

var _TaskConfirmModal2 = _interopRequireDefault(_TaskConfirmModal);
...
var columns = ['material_index', 'work_order_uid', 'process_id', 'process_name', 'work_hour', 'estimated_start_dt', 'estimated_finish_dt', 'work_group_name', 'action'];

var ProductionPlan = function (_React$Component) {
  (0, _inherits3.default)(ProductionPlan, _React$Component);

  function ProductionPlan(props) {
    (0, _classCallCheck3.default)(this, ProductionPlan);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ProductionPlan.__proto__ || (0, _getPrototypeOf2.default)(ProductionPlan)).call(this, props));
    ...
    _this.handleConfirm = function (e) {
      ...
      (0, _api2.default)(_config.apis.ProductionAPI.updateProcessDetails, { status: _const.PROCESS_DETAIL_STATUS.CONFIRMED, confirm_status: true }, { id: id }).then(function (repos) {
        _message4.default.success('修改成功！');
    ...
    _this.fetchProcessDetailItem = function (id, cb) {
      (0, _api2.default)(_config.apis.ProductionAPI.getProcessDetailItem, null, { id: id }).then(function (repos) {
        cb(repos);
      });
    };
    ...
    _this.handleOpenEditModal = function (e) {
      ...
      _this.fetchProcessDetailItem(id, function (repos) {
    ...
    _this.handleSave = function (fieldsValue) {
      (0, _api2.default)(_config.apis.ProductionAPI.updateProcessDetails, fieldsValue, { id: fieldsValue.id }).then(function (repos) {
  ...
  (0, _createClass3.default)(ProductionPlan, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        estimated_start_dt: {
          render: function render(text, record, index) {
            return record.estimated_start_dt && (0, _moment2.default)(record.estimated_start_dt).format('YYYY-MM-DD');
          }
        },
        estimated_finish_dt: {
          render: function render(text, record, index) {
            return record.estimated_finish_dt && (0, _moment2.default)(record.estimated_finish_dt).format('YYYY-MM-DD');
          }
        },
        action: {
          render: function render(text, record, index) {
            if (record.status === _const.PROCESS_DETAIL_STATUS.INSPECTED) {
              return _react2.default.createElement(
                _button2.default,
                {
                  type: 'primary',
            ...
            } else if (record.status === _const.PROCESS_DETAIL_STATUS.CONFIRMED) {
              return _react2.default.createElement(
                _button2.default,
                {
                  type: 'primary',
    ...
    value: function updateQuery() {
      ...
      var filterQuery = _lodash2.default.forEach(mergeQuery, function (item, key) {
        if (item === '' || _lodash2.default.isUndefined(item) || _lodash2.default.isNull(item)) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_TaskConfirmModal2.default, (0, _extends3.default)({
...
exports.default = ProductionPlan;
...
var _TaskInfoTable = __webpack_require__(1544);

var _TaskInfoTable2 = _interopRequireDefault(_TaskInfoTable);
 ...
 */
var ProductionPlanModal = function (_React$Component) {
  (0, _inherits3.default)(ProductionPlanModal, _React$Component);

  function ProductionPlanModal(props) {
    (0, _classCallCheck3.default)(this, ProductionPlanModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ProductionPlanModal.__proto__ || (0, _getPrototypeOf2.default)(ProductionPlanModal)).call(this, props));
    ...
    _this.handleSave = function () {
      ...
      form.validateFields(function (err, values) {
        ...
        values.remark = _this.state.remark;
        values.status = _const.PROCESS_DETAIL_STATUS.INSPECTED;
    ...
    _this.getFooter = function (status) {
      if (status === _const.PROCESS_DETAIL_STATUS.INSPECTED) {
        return [_react2.default.createElement(
          _button2.default,
          {
            key: 'back',
      ...
      } else if (status === _const.PROCESS_DETAIL_STATUS.CONFIRMED) {
        return [_react2.default.createElement(
          _button2.default,
          {
            key: 'submit',
    ...
    _this.onChange = function (remark) {
      _this.state.remark = remark;
  ...
  (0, _createClass3.default)(ProductionPlanModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_TaskInfoTable2.default, { taskInfo: this.props.fieldsValue, onChange: this.onChange })
        )
      );
    }
  }]);
  return ProductionPlanModal;
}(_react2.default.Component);
...
var makeFileds = function makeFileds(fieldsValue) {
  var result = {};
  _lodash2.default.forEach(fieldsValue, function (value, key) {
    result[key] = _form2.default.createFormField({ value: value });
  });
...
var TaskInfoTable = function (_React$Component) {
  (0, _inherits3.default)(TaskInfoTable, _React$Component);

  function TaskInfoTable(props) {
    (0, _classCallCheck3.default)(this, TaskInfoTable);

    var _this = (0, _possibleConstructorReturn3.default)(this, (TaskInfoTable.__proto__ || (0, _getPrototypeOf2.default)(TaskInfoTable)).call(this, props));

    _this.handleChange = function (e) {
      console.log(111111111);
      _this.setState({ remark: e.target.value });
      _this.props.onChange(_this.state.remark);
    };
  ...
  (0, _createClass3.default)(TaskInfoTable, [{
    key: 'getRemarkInfo',
    value: function getRemarkInfo(status, confirmStatus, remark) {
      if ( /* confirmStatus && */status === _const.PROCESS_DETAIL_STATUS.CONFIRMED) {
        return _react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u68C0\u67E5\u5185\u5BB9', type: 'text', value: this.state.remark, onChange: this.handleChange, className: 'remark-input' });
      } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'work-order-uid-label' },
              '\u5DE5\u4F5C\u4EE4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 8, className: 'work-order-uid-value' },
              taskInfo.work_order_uid
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'material-index-label' },
              '\u5DE5\u4F5C\u7968\u53F7'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'material-index-value' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'process-id-label' },
              '\u5DE5\u5E8F\u53F7'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'process-id-value' },
              taskInfo.process_id
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'process-name-label' },
              '\u5DE5\u5E8F'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'process-name-value' },
              taskInfo.process_name
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'work-hour-label' },
              '\u5DE5\u65F6'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 2, className: 'work-hour-value' },
              taskInfo.work_hour
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'estimated-start-dt-label' },
              '\u8BA1\u5212\u5F00\u59CB\u65F6\u95F4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'estimated-start-dt-value' },
              (0, _moment2.default)(taskInfo.estimated_start_dt).format('YYYY-MM-DD')
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'estimated-end-dt-label' },
              '\u8BA1\u5212\u5B8C\u6210\u65F6\u95F4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'estimated-end-dt-value' },
              (0, _moment2.default)(taskInfo.estimated_finish_dt).format('YYYY-MM-DD')
            )
          ),
          _react2.default.createElement(
            'tr',
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'work-group-label' },
              '\u64CD\u4F5C\u7EC4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'work-group-value' },
              taskInfo.work_group
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'actual-finish-dt-label' },
              '\u5B9E\u9645\u5B8C\u6210\u65F6\u95F4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'actual-finish-dt-value' },
              taskInfo.actual_finish_dt && (0, _moment2.default)(taskInfo.actual_finish_dt).format('YYYY-MM-DD')
            )
          ),
          _react2.default.createElement(
            'tr',
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 1, className: 'remark-label' },
              '\u68C0\u67E5\u5185\u5BB9'
            ),
            _react2.default.createElement(
              'td',
              { id: 'td_check_content', colSpan: 13, className: 'remark-value' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'inspector-name-label' },
              '\u68C0\u67E5\u8005'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'inspector-name-value' },
              taskInfo.inspector_name
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 3, className: 'inspection-dt-label' },
              '\u68C0\u67E5\u65F6\u95F4'
            ),
            _react2.default.createElement(
              'td',
              { colSpan: 4, className: 'actual-finish-dt-value' },
              taskInfo.inspection_dt && (0, _moment2.default)(taskInfo.inspection_dt).format('YYYY-MM-DD')
            )
          )
        )
      );
...
var TASK_CONFIRM_GET_LIST_DATA = 'TASK_CONFIRM_GET_LIST_DATA';
var TASK_CONFIRM_ADD_LIST_DATA = 'TASK_CONFIRM_ADD_LIST_DATA';
var TASK_CONFIRM_CHANGE_MODAL_DATA = 'TASK_CONFIRM_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function TaskConfirm() {
  ...
  var map = {
    TASK_CONFIRM_GET_LIST_DATA: function TASK_CONFIRM_GET_LIST_DATA() {
    ...
    TASK_CONFIRM_ADD_LIST_DATA: function TASK_CONFIRM_ADD_LIST_DATA() {
    ...
    TASK_CONFIRM_CHANGE_MODAL_DATA: function TASK_CONFIRM_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(TASK_CONFIRM_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProductionAPI.getProcessDetail, params);
