...
var _modules = __webpack_require__(944);

var _MaterialExecution = __webpack_require__(1568);

var _MaterialExecution2 = _interopRequireDefault(_MaterialExecution);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_MaterialExecution2.default));
...
var _FilterBar = __webpack_require__(1567);
...
var columns = ['uid_execution', 'lister', 'list_dt', 'process_requirement', 'action'];

var MaterialExecution = function (_React$Component) {
  (0, _inherits3.default)(MaterialExecution, _React$Component);

  function MaterialExecution(props) {
    (0, _classCallCheck3.default)(this, MaterialExecution);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MaterialExecution.__proto__ || (0, _getPrototypeOf2.default)(MaterialExecution)).call(this, props));
  ...
  (0, _createClass3.default)(MaterialExecution, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { to: '/purchase/material_execution/material_execution_detail/?id=' + record.id },
                '\u67E5\u770B'
              )
            );
          }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/purchase/material_execution/material_execution_detail' },
            '\u65B0\u5EFA\u6750\u6599\u6267\u884C\u8868'
          )
        ),
...
exports.default = MaterialExecution;
...
var MATERIALEXECUTION_GET_LIST_DATA = 'MATERIALEXECUTION_GET_LIST_DATA';
var MATERIALEXECUTION_ADD_LIST_DATA = 'MATERIALEXECUTION_ADD_LIST_DATA';
var MATERIALEXECUTION_CHANGE_MODAL = 'MATERIALEXECUTION_CHANGE_MODAL';
var PAGE_SIZE = 10;
...
function MaterialExecution() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    MATERIALEXECUTION_GET_LIST_DATA: function MATERIALEXECUTION_GET_LIST_DATA() {
    ...
    MATERIALEXECUTION_ADD_LIST_DATA: function MATERIALEXECUTION_ADD_LIST_DATA() {
    ...
    MATERIALEXECUTION_CHANGE_MODAL: function MATERIALEXECUTION_CHANGE_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(MATERIALEXECUTION_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getMaterialExecutions, params);
