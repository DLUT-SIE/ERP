...
var columns = ['production_name', 'send_file', 'upload_file', 'pretty_status', 'action'];

var Production = function (_React$Component) {
  (0, _inherits3.default)(Production, _React$Component);

  function Production(props) {
    (0, _classCallCheck3.default)(this, Production);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Production.__proto__ || (0, _getPrototypeOf2.default)(Production)).call(this, props));

    _this.uploadFile = function (file) {
      (0, _api2.default)(_config.apis.DistributionAPI.uploadBidFile, (0, _extends3.default)({
        path: file.file
    ...
    _this.getDepartmentFile = function (deptName, documents) {
      var deptMap = _this.state.deptMap;

      var deptId = deptMap[deptName];
      var document = _lodash2.default.find(documents, function (document) {
    ...
    _this.handleChangeTable = function (pagination, filters, sorter) {
      _this.props.getListDataAction({
        params: {
          related: _this._deptMap[_this._deptType],
    ...
    _this._deptType = _this.props.location.pathname.split('/')[2].split('_')[0];
    _this._deptMap = window.erpConfig.deptMap;
    _this._columns = _this.buildColumns();
    return _this;
  }

  (0, _createClass3.default)(Production, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function buildColumns() {
      ...
      var deptMap = this._deptMap;
      return _utils2.default.buildColumns(columns, {
        send_file: {
          render: function render(text, record, index) {
            var document = record.documents_from_distribution[_this2._deptType];
        ...
        upload_file: {
          render: function render(text, record, index) {
            var document = record.documents_to_distribution[_this2._deptType];
            return document ? _react2.default.createElement(
              'a',
              {
                className: 'document-link',
        ...
        action: {
          render: function render(text, record, index) {
            var document = record.documents_to_distribution[_this2._deptType];
            var data = { product: record.id, dst: deptMap['distribution'], src: deptMap[_this2._deptType] };
            return document && document.pretty_status === '通过' ? '已上传' : _react2.default.createElement(
              _upload2.default,
              {
                name: 'file',
                data: data,
...
exports.default = DepartmentSend;
...
var DEPARTMENTSEND_GET_LIST_DATA = 'DEPARTMENTSEND_GET_LIST_DATA';
var DEPARTMENTSEND_ADD_LIST_DATA = 'DEPARTMENTSEND_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function DepartmentSend() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    DEPARTMENTSEND_GET_LIST_DATA: function DEPARTMENTSEND_GET_LIST_DATA() {
    ...
    DEPARTMENTSEND_ADD_LIST_DATA: function DEPARTMENTSEND_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(DEPARTMENTSEND_GET_LIST_DATA);
...
var _modules = __webpack_require__(885);

var _DepartmentSend = __webpack_require__(1422);

var _DepartmentSend2 = _interopRequireDefault(_DepartmentSend);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_DepartmentSend2.default));
