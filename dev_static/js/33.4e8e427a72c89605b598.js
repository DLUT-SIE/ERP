...
var _modules = __webpack_require__(915);

var _PrincipalQuota = __webpack_require__(1489);

var _PrincipalQuota2 = _interopRequireDefault(_PrincipalQuota);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PrincipalQuota2.default));
...
var _PrincipalQuotaModal = __webpack_require__(1490);

var _PrincipalQuotaModal2 = _interopRequireDefault(_PrincipalQuotaModal);

__webpack_require__(1669);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['size', 'count', 'weight', 'total_weight', 'material_name_in_quota', 'operative_norm', 'status', 'remark', 'action'];

var PrincipalQuota = function (_React$Component) {
  (0, _inherits3.default)(PrincipalQuota, _React$Component);

  function PrincipalQuota(props) {
    (0, _classCallCheck3.default)(this, PrincipalQuota);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PrincipalQuota.__proto__ || (0, _getPrototypeOf2.default)(PrincipalQuota)).call(this, props));

    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProcessAPI.deletePrincipalQuota, {}, { id: id }).then(function (repos) {
          _message7.default.success('删除成功！');
    ...
    _this.handleOpenEditModal = function (e) {
      ...
      _this.fetchPrincipalQuota(id, function (repos) {
    ...
    _this.handleChangePrincipalQuota = function (e) {
      var type = e.target.dataset.type;
      var _this$props = _this.props,
          status = _this$props.status,
          changeModalAction = _this$props.changeModalAction;
      ...
      if (type === 'previous') {
        if (index === 0) {
          _message7.default.warning('本条已为当前页第一条！');
          return;
        }
        index -= 1;
      } else {
        if (index === list.length - 1) {
          _message7.default.warning('本条已为当前页的最后一条！');
          return;
        }
        index += 1;
      }
      _this.fetchPrincipalQuota(list[index].id, function (repos) {
        changeModalAction({
          visible: true,
          index: index,
          fieldsValue: repos
    ...
    _this.handleSave = function (id, fieldsValue) {
      if (id) {
        (0, _api2.default)(_config.apis.ProcessAPI.updatePincipalQuota, fieldsValue, { id: id }).then(function (repos) {
          _message7.default.success('修改成功！');
      ...
      (0, _api2.default)(_config.apis.ProcessAPI.addPincipalQuota, (0, _extends3.default)({}, fieldsValue, {
    ...
    _this._category = _const.DETAILED_TABLE_CATEGORY_MAP['主材定额明细表'];
    return _this;
  }

  (0, _createClass3.default)(PrincipalQuota, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    key: 'fetchPrincipalQuota',
    value: function fetchPrincipalQuota(id, cb) {
      (0, _api2.default)(_config.apis.ProcessAPI.getPrincipalQuota, {}, { id: id }).then(function (repos) {
        cb(repos);
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var workOrderInfo = _lodash2.default.get(mydata, 'workOrderInfo', {});
      var materials = _lodash2.default.get(mydata, 'materials', {});
      var modal = _lodash2.default.get(mydata, 'modal', {});
      return _react2.default.createElement(
        'div',
        { className: 'principal-quota' },
        ...
        modal.visible && _react2.default.createElement(_PrincipalQuotaModal2.default, (0, _extends3.default)({
...
exports.default = PrincipalQuota;
...
var PrincipalQuotaModal = function (_React$Component) {
  (0, _inherits3.default)(PrincipalQuotaModal, _React$Component);

  function PrincipalQuotaModal(props) {
    (0, _classCallCheck3.default)(this, PrincipalQuotaModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PrincipalQuotaModal.__proto__ || (0, _getPrototypeOf2.default)(PrincipalQuotaModal)).call(this, props));
  ...
  (0, _createClass3.default)(PrincipalQuotaModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u89C4\u683C' }, formItemLayout),
                getFieldDecorator('size', fieldsConfig['size'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u89C4\u683C' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                ...
                getFieldDecorator('count', fieldsConfig['count'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6570\u91CF' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u5355\u91CD' }, formItemLayout),
                getFieldDecorator('weight', fieldsConfig['weight'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u5355\u91CD' }))
              )
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u6750\u8D28' }, formItemLayout),
                getFieldDecorator('material', fieldsConfig['material'])(_react2.default.createElement(_CustomSelect2.default, {
                  placeholder: '\u8BF7\u9009\u62E9\u6750\u8D28',
                  list: materials
                }))
              )
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u6267\u884C\u6807\u51C6' }, formItemLayout),
                getFieldDecorator('operative_norm', fieldsConfig['operative_norm'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6267\u884C\u6807\u51C6' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u4F9B\u8D27\u72B6\u6001' }, formItemLayout),
                getFieldDecorator('status', fieldsConfig['status'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u4F9B\u8D27\u72B6\u6001' }))
              )
            )
          ),
          _react2.default.createElement(
  ...
  return PrincipalQuotaModal;
}(_react2.default.Component);

PrincipalQuotaModal.propTypes = {
  visible: _propTypes2.default.bool.isRequired,
  fieldsValue: _propTypes2.default.object.isRequired,
  materials: _propTypes2.default.array.isRequired,
...
var PRINCIPAL_GET_LIST_DATA = 'PRINCIPAL_GET_LIST_DATA';
var PRINCIPAL_ADD_LIST_DATA = 'PRINCIPAL_ADD_LIST_DATA';
var PRINCIPAL_GET_LIBRARY_DATA = 'PRINCIPAL_GET_LIBRARY_DATA';
var PRINCIPAL_ADD_LIBRARY_DATA = 'PRINCIPAL_ADD_LIBRARY_DATA';
var PRINCIPAL_GET_MATERIALS_DATA = 'PRINCIPAL_GET_MATERIALS_DATA';
var PRINCIPAL_ADD_MATERIALS_DATA = 'PRINCIPAL_ADD_MATERIALS_DATA';
var PRINCIPAL_RESET_DATA = 'PRINCIPAL_RESET_DATA';
var PRINCIPAL_CHANGE_MODAL_DATA = 'PRINCIPAL_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function PrincipalQuota() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    PRINCIPAL_GET_LIST_DATA: function PRINCIPAL_GET_LIST_DATA() {
    ...
    PRINCIPAL_ADD_LIST_DATA: function PRINCIPAL_ADD_LIST_DATA() {
    ...
    PRINCIPAL_ADD_LIBRARY_DATA: function PRINCIPAL_ADD_LIBRARY_DATA() {
      var data = action.payload.data;
    ...
    PRINCIPAL_ADD_MATERIALS_DATA: function PRINCIPAL_ADD_MATERIALS_DATA() {
      var data = action.payload.data;

      var materials = _lodash2.default.map(data.results, function (item) {
        return {
          value: item.id,
          label: item.name
        };
    ...
    PRINCIPAL_RESET_DATA: function PRINCIPAL_RESET_DATA() {
      return state.merge({
        workOrderInfo: {},
        list: []
      });
    },
    PRINCIPAL_CHANGE_MODAL_DATA: function PRINCIPAL_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PRINCIPAL_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getPrincipalQuotas, params);
...
function getLibrarySaga(type, body) {
  var _ref2, _ref2$payload, _payload, _callback, _payload$params2, _params, data;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(PRINCIPAL_GET_LIBRARY_DATA);
        ...
        case 3:
          ...
          _context2.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getQuotaList, _params);
        ...
        case 9:
          ...
          _context2.next = 13;
          return (0, _effects.put)(addLibraryDataAction({ data: data }));
...
function getMaterialsSaga(type, body) {
  var _ref3, _ref3$payload, _payload2, _payload2$params, _params2, data;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _effects.take)(PRINCIPAL_GET_MATERIALS_DATA);
        ...
        case 3:
          ...
          _context3.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getMaterials, _params2);

        case 9:
          data = _context3.sent;
          _context3.next = 12;
          return (0, _effects.put)(addMaterialsAction({ data: data }));
