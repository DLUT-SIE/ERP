...
var _modules = __webpack_require__(941);

var _ContractDetail = __webpack_require__(1563);

var _ContractDetail2 = _interopRequireDefault(_ContractDetail);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ContractDetail2.default));
...
var columns = ['submitter', 'amount', 'submit_dt'];

var ContractDetail = function (_React$Component) {
  (0, _inherits3.default)(ContractDetail, _React$Component);

  function ContractDetail(props) {
    (0, _classCallCheck3.default)(this, ContractDetail);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ContractDetail.__proto__ || (0, _getPrototypeOf2.default)(ContractDetail)).call(this, props));
  ...
  (0, _createClass3.default)(ContractDetail, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
...
exports.default = ContractDetail;
...
var CONTRACTDETAIL_GET_LIST_DATA = 'CONTRACTDETAIL_GET_LIST_DATA';
var CONTRACTDETAIL_ADD_LIST_DATA = 'CONTRACTDETAIL_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function ContractDetail() {
  ...
  var map = {
    CONTRACTDETAIL_GET_LIST_DATA: function CONTRACTDETAIL_GET_LIST_DATA() {
    ...
    CONTRACTDETAIL_ADD_LIST_DATA: function CONTRACTDETAIL_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(CONTRACTDETAIL_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getContractDetails, params);
