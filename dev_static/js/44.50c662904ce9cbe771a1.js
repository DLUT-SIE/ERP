...
var _modules = __webpack_require__(959);

var _SupplierDocument = __webpack_require__(1611);

var _SupplierDocument2 = _interopRequireDefault(_SupplierDocument);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_SupplierDocument2.default));
...
var columns = ['doc_name', 'doc_size', 'upload_dt', 'action'];

var SupplierDocument = function (_React$Component) {
  (0, _inherits3.default)(SupplierDocument, _React$Component);

  function SupplierDocument(props) {
    (0, _classCallCheck3.default)(this, SupplierDocument);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SupplierDocument.__proto__ || (0, _getPrototypeOf2.default)(SupplierDocument)).call(this, props));
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.deleteSupplierDocument, {}, { id: id }).then(function (repos) {
          _message4.default.success('删除成功！');
          _this.fetchData(_this._query());
        });
      };
    };

    _this.uploadFile = function (file) {
      (0, _api2.default)(_config.apis.PurchaseAPI.addSupplierDocument, (0, _extends3.default)({
        path: file.file
      }, file.data), {}, true).then(function () {
        _message4.default.success('上传成功');
        _this.updatelist();
      });
    };
  ...
  (0, _createClass3.default)(SupplierDocument, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        doc_name: {
          render: function render(text, record, index) {
            return record.doc_name && _react2.default.createElement(
              'a',
              {
    ...
    value: function render() {
      ...
      var data = { supplier: this._id };
      return _react2.default.createElement(
        'div',
        { className: 'supplier-document' },
        _react2.default.createElement(
          'h1',
          { className: 'title' },
          '\u4F9B\u5E94\u5546\u7F16\u53F7\uFF1A',
...
exports.default = SupplierDocument;
...
var SUPPLIERDOCUMENT_GET_LIST_DATA = 'SUPPLIERDOCUMENT_GET_LIST_DATA';
var SUPPLIERDOCUMENT_ADD_LIST_DATA = 'SUPPLIERDOCUMENT_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function SupplierDocument() {
  ...
  var map = {
    SUPPLIERDOCUMENT_GET_LIST_DATA: function SUPPLIERDOCUMENT_GET_LIST_DATA() {
    ...
    SUPPLIERDOCUMENT_ADD_LIST_DATA: function SUPPLIERDOCUMENT_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(SUPPLIERDOCUMENT_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getSupplierDocuments, params);
