...
var _modules = __webpack_require__(931);

var _ProductionUsers = __webpack_require__(1537);

var _ProductionUsers2 = _interopRequireDefault(_ProductionUsers);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ProductionUsers2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('name')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u59D3\u540D' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('work_group')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5DE5\u4F5C\u7EC4' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { to: '/production/create_production_user' },
              '\u6DFB\u52A0\u4EBA\u5458'
            )
          )
        )
...
var ProductionUserModal = function (_React$Component) {
  (0, _inherits3.default)(ProductionUserModal, _React$Component);

  function ProductionUserModal(props) {
    (0, _classCallCheck3.default)(this, ProductionUserModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ProductionUserModal.__proto__ || (0, _getPrototypeOf2.default)(ProductionUserModal)).call(this, props));
  ...
  (0, _createClass3.default)(ProductionUserModal, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u7528\u6237\u540D' }, formItemLayout),
            _react2.default.createElement(_input2.default, { disabled: true, value: this.state.first_name })
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u6240\u5C5E\u5DE5\u4F5C\u7EC4' }, formItemLayout),
            getFieldDecorator('work_group_name')(_react2.default.createElement(_CustomSelect2.default, { placeholder: '\u8BF7\u9009\u62E9\u6240\u5C5E\u5DE5\u4F5C\u7EC4', list: this.state.groups
            }))
          )
        )
      );
...
var _FilterBar = __webpack_require__(1535);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _ProductionUserModal = __webpack_require__(1536);

var _ProductionUserModal2 = _interopRequireDefault(_ProductionUserModal);
...
var columns = ['first_name', 'work_group_name', 'action'];

var ProductionUsers = function (_React$Component) {
  (0, _inherits3.default)(ProductionUsers, _React$Component);

  function ProductionUsers(props) {
    (0, _classCallCheck3.default)(this, ProductionUsers);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ProductionUsers.__proto__ || (0, _getPrototypeOf2.default)(ProductionUsers)).call(this, props));
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProductionAPI.deleteProductionUser, {}, { id: id }).then(function () {
    ...
    _this.handleSave = function (fieldsValue) {
      (0, _api2.default)(_config.apis.ProductionAPI.updateProductionUserGroup, fieldsValue, { id: fieldsValue.id }).then(function () {
  ...
  (0, _createClass3.default)(ProductionUsers, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_ProductionUserModal2.default, (0, _extends3.default)({
          onOk: this.handleSave,
...
exports.default = ProductionUsers;
...
var PRODUCTION_USER_GET_LIST_DATA = 'PRODUCTION_USER_GET_LIST_DATA';
var PRODUCTION_USER_ADD_LIST_DATA = 'PRODUCTION_USER_ADD_LIST_DATA';
var PRODUCTION_USER_CHANGE_MODAL_DATA = 'PRODUCTION_USER_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function ProductionUsers() {
  ...
  var map = {
    PRODUCTION_USER_GET_LIST_DATA: function PRODUCTION_USER_GET_LIST_DATA() {
    ...
    PRODUCTION_USER_ADD_LIST_DATA: function PRODUCTION_USER_ADD_LIST_DATA() {
    ...
    PRODUCTION_USER_CHANGE_MODAL_DATA: function PRODUCTION_USER_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PRODUCTION_USER_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProductionAPI.getProductionUsers, params);
