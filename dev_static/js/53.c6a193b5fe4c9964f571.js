...
var _modules = __webpack_require__(927);

var _MaterialRefundCard = __webpack_require__(1526);

var _MaterialRefundCard2 = _interopRequireDefault(_MaterialRefundCard);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_MaterialRefundCard2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u9000\u5E93\u5355\u7F16\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('category', {
            initialValue: _const.MATERIAL_REFUND_CARD_TYPE.WELD,
            rules: [{ required: true, message: '请选择材料类型' }] })(_react2.default.createElement(_CustomSelect2.default, { list: _const.MATERIAL_REFUND_CARD, placeholder: '\u8BF7\u9009\u62E9\u6750\u6599\u7C7B\u578B' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { to: '/production/material_refund_card/create_material_refund_card' },
              '\u6DFB\u52A0\u9000\u5E93\u5361'
            )
          )
        )
...
var makeFields = function makeFields(fieldsValue) {
  ...
  _lodash2.default.forEach(fieldsValue, function (value, key) {
    ...
    if (key === 'category' && _lodash2.default.isNull(value)) {
      result[key] = _form2.default.createFormField({ value: _const.MATERIAL_REFUND_CARD_TYPE.WELD });
    }
  });
  return result;
};
...
var _FilterBar = __webpack_require__(1525);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _MaterialRefundCardModal = __webpack_require__(1527);

var _MaterialRefundCardModal2 = _interopRequireDefault(_MaterialRefundCardModal);
...
var columns = ['refund_uid', 'sub_order_uid', 'apply_uid', 'create_dt', 'pretty_status', 'action'];
var mapRequest = {
  welding_material_refund_cards: _config.apis.ProductionAPI.getWeldingMaterialRefundCardDetails,
  steel_material_refund_cards: _config.apis.ProductionAPI.getSteelMaterialRefundCardDetails,
  bought_in_component_refund_cards: _config.apis.ProductionAPI.getBroughtInMaterialRefundCardDetails,
  auxiliary_material_refund_cards: _config.apis.ProductionAPI.getAuxiliaryMaterialRefundCardDetails
};
var updateMapRequest = {
  welding_material_refund_cards: _config.apis.ProductionAPI.updateWeldMaterialRefundcardStatus,
  steel_material_refund_cards: _config.apis.ProductionAPI.updatSteelMaterialRefundcardStatus,
  bought_in_component_refund_cards: _config.apis.ProductionAPI.updateBroughtInMaterialRefundcardStatus
};

var MaterialApplyCard = function (_React$Component) {
  (0, _inherits3.default)(MaterialApplyCard, _React$Component);

  function MaterialApplyCard(props) {
    (0, _classCallCheck3.default)(this, MaterialApplyCard);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MaterialApplyCard.__proto__ || (0, _getPrototypeOf2.default)(MaterialApplyCard)).call(this, props));

    _this.handleSearch = function (searchValue) {
      var _searchValue = (0, _extends3.default)({}, searchValue);
      var category = _searchValue.category;
    ...
    _this.fetchDetails = function (category, id, cb) {
      (0, _api2.default)(mapRequest[category], null, { id: id }).then(function (repos) {
        cb(repos);
      });
    };
    ...
    _this.handleOpenEditModal = function (e) {
      var _e$target$dataset = e.target.dataset,
          ...
          category = _e$target$dataset.category,
          id = _e$target$dataset.id;

      _this.fetchDetails(category, id, function (repos) {
        var values = repos;
        values.create_dt = (0, _moment2.default)(repos.create_dt).format('YYYY-MM-DD');
    ...
    _this.changeStatus = function (type, id, actions) {
      console.log('actions', actions);
      (0, _api2.default)(updateMapRequest[type], { status: actions }, { id: id }).then(function (repos) {
  ...
  (0, _createClass3.default)(MaterialApplyCard, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      console.log(this._query());
      var params = this._query();
      if (_lodash2.default.isUndefined(params.category)) {
        this.setState({ category: _const.MATERIAL_REFUND_CARD_TYPE.WELD });
      }
      ...
      return _utils2.default.buildColumns(columns, {
        create_dt: {
          render: function render(text, record, index) {
            return (0, _moment2.default)(record.create_dt).format('YYYY-MM-DD');
          }
        },
        action: {
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _button2.default,
                {
                  ...
                  'data-id': record.id,
                  'data-index': index,
                  'data-category': _this2.state.category,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_MaterialRefundCardModal2.default, (0, _extends3.default)({
...
exports.default = MaterialApplyCard;
...
var _WeldMaterialRefundCardTable = __webpack_require__(384);

var _WeldMaterialRefundCardTable2 = _interopRequireDefault(_WeldMaterialRefundCardTable);

var _SteelBoardMaterialRefundCardTable = __webpack_require__(383);

var _SteelBoardMaterialRefundCardTable2 = _interopRequireDefault(_SteelBoardMaterialRefundCardTable);

var _SteelBarMaterialRefundCardTable = __webpack_require__(382);

var _SteelBarMaterialRefundCardTable2 = _interopRequireDefault(_SteelBarMaterialRefundCardTable);

var _BroughtInMaterialRefundCardTable = __webpack_require__(381);

var _BroughtInMaterialRefundCardTable2 = _interopRequireDefault(_BroughtInMaterialRefundCardTable);

var _const = __webpack_require__(50);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MaterialRefundCardModal = function (_React$Component) {
  (0, _inherits3.default)(MaterialRefundCardModal, _React$Component);

  function MaterialRefundCardModal(props) {
    (0, _classCallCheck3.default)(this, MaterialRefundCardModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MaterialRefundCardModal.__proto__ || (0, _getPrototypeOf2.default)(MaterialRefundCardModal)).call(this, props));
  ...
  (0, _createClass3.default)(MaterialRefundCardModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.category === _const.MATERIAL_REFUND_CARD_TYPE.WELD ? _react2.default.createElement(_WeldMaterialRefundCardTable2.default, { details: this.props.details, changeStatus: this.changeStatus }) : '',
          this.props.category === _const.MATERIAL_REFUND_CARD_TYPE.STEEL && this.props.details.steel_type === 0 ? _react2.default.createElement(_SteelBoardMaterialRefundCardTable2.default, { details: this.props.details, changeStatus: this.changeStatus }) : '',
          this.props.category === _const.MATERIAL_REFUND_CARD_TYPE.STEEL && this.props.details.steel_type === 1 ? _react2.default.createElement(_SteelBarMaterialRefundCardTable2.default, { details: this.props.details, changeStatus: this.changeStatus }) : '',
          this.props.category === _const.MATERIAL_REFUND_CARD_TYPE.BROUGHT_IN ? _react2.default.createElement(_BroughtInMaterialRefundCardTable2.default, { details: this.props.details, changeStatus: this.changeStatus }) : ''
        )
      );
    }
  }]);
  return MaterialRefundCardModal;
}(_react2.default.Component); /**
...
var REFUND_CARD_GET_LIST_DATA = 'REFUND_CARD_GET_LIST_DATA';
var REFUND_CARD_ADD_LIST_DATA = 'REFUND_CARD_ADD_LIST_DATA';
var REFUND_CARD_CHANGE_MODAL_DATA = 'REFUND_CARD_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function RefundCard() {
  ...
  var map = {
    REFUND_CARD_GET_LIST_DATA: function REFUND_CARD_GET_LIST_DATA() {
    ...
    REFUND_CARD_ADD_LIST_DATA: function REFUND_CARD_ADD_LIST_DATA() {
    ...
    REFUND_CARD_CHANGE_MODAL_DATA: function REFUND_CARD_CHANGE_MODAL_DATA() {
...
// ------------------------------------
var mapRequest = {
  welding_material_refund_cards: _config.apis.ProductionAPI.getWeldingMaterialRefundCards,
  steel_material_refund_cards: _config.apis.ProductionAPI.getSteelMaterialRefundCards,
  bought_in_component_refund_cards: _config.apis.ProductionAPI.getBroughtInMaterialRefundCards
};
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, category, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(REFUND_CARD_GET_LIST_DATA);
        ...
        case 3:
          ...
          category = mapRequest[params.category];

          if (_lodash2.default.isUndefined(category)) {
            category = _config.apis.ProductionAPI.getWeldingMaterialRefundCards;
          }
          _context.next = 11;
          return (0, _effects.call)(_api2.default, category, params);
