...
var _modules = __webpack_require__(916);

var _Process = __webpack_require__(1492);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Process2.default));
...
var CreateTransferCardModal = function (_React$Component) {
  (0, _inherits3.default)(CreateTransferCardModal, _React$Component);

  function CreateTransferCardModal(props) {
    (0, _classCallCheck3.default)(this, CreateTransferCardModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CreateTransferCardModal.__proto__ || (0, _getPrototypeOf2.default)(CreateTransferCardModal)).call(this, props));
  ...
  (0, _createClass3.default)(CreateTransferCardModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u6D41\u8F6C\u5361\u7C7B\u578B' }, formItemLayout),
            form.getFieldDecorator('category', fieldsConfig['category'])(_react2.default.createElement(_CustomSelect2.default, {
              placeholder: '\u8BF7\u9009\u62E9\u6D41\u8F6C\u5361\u7C7B\u578B',
              list: _const.TRANSFERCARD_CATEGORY_LIST
            }))
          )
        )
      );
  ...
  return CreateTransferCardModal;
}(_react2.default.Component);
...
var WrappedForm = _form2.default.create()(CreateTransferCardModal);
...
var _message6 = __webpack_require__(29);
...
var _TableInfo = __webpack_require__(1494);

var _TableInfo2 = _interopRequireDefault(_TableInfo);

var _RouteModal = __webpack_require__(1493);
...
var _CreateTransferCardModal = __webpack_require__(1491);

var _CreateTransferCardModal2 = _interopRequireDefault(_CreateTransferCardModal);

__webpack_require__(1672);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['ticket_number', 'part_number', 'drawing_number', 'lib_name', 'spec', 'material', 'count', 'piece_weight', 'total_weight', 'remark', 'circulation_route', 'process_route', 'transferCard', 'weldingSeam'];

var ProcessImport = function (_React$Component) {
  (0, _inherits3.default)(ProcessImport, _React$Component);

  function ProcessImport(props) {
    (0, _classCallCheck3.default)(this, ProcessImport);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ProcessImport.__proto__ || (0, _getPrototypeOf2.default)(ProcessImport)).call(this, props));
    ...
    _this.handleOpenRouteModal = function (e) {
      var _e$target$dataset = e.target.dataset,
          processMaterial = _e$target$dataset.processMaterial,
          index = _e$target$dataset.index,
          routeType = _e$target$dataset.routeType;

      processMaterial = JSON.parse(processMaterial);
      if (routeType === 'circulation') {
        (0, _api2.default)(_config.apis.ProcessAPI.getCirculationRoute, {
          process_material: processMaterial.id
        }).then(function (repos) {
          _this.props.changeRouteModalAction({
            routeType: routeType,
            index: +index,
            ...
            number: 10,
            prefix: 'L',
            list: _const.CICULATION_ROUTE_LIST,
            fieldsValue: repos.results[0].circulation_routes,
            routeId: +repos.results[0].id
          });
        });
      } else {
        (0, _api2.default)(_config.apis.ProcessAPI.getProcessRoute, {
          process_material: processMaterial.id
        }).then(function (repos) {
          _this.props.changeRouteModalAction({
            routeType: routeType,
            ...
            number: 12,
            prefix: '工序',
            list: _const.PROCESS_ROUTE_LIST,
    ...
    _this.handleCloseRouteModal = function () {
      _this.props.changeRouteModalAction({
        visible: false
      });
    };

    _this.handleChange = function (changeType) {
      var status = _this.props.status;

      var mydata = status.toJS();
      var list = _lodash2.default.get(mydata, 'list', []);
      var routeModal = _lodash2.default.get(mydata, 'routeModal', {});
      var routeType = routeModal.routeType,
          index = routeModal.index;

      var api = routeType === 'circulation' ? 'getCirculationRoute' : 'getProcessRoute';
      if (changeType === 'previous') {
        if (index === 0) {
          _message7.default.warning('当前为本页第一条！');
          return;
        }
        index -= 1;
      } else {
        if (index === list.length - 1) {
          _message7.default.warning('当前为本页最后一条！');
          return;
        }
        index += 1;
      }
      var processMaterial = list[index];
      (0, _api2.default)(_config.apis.ProcessAPI[api], {
        process_material: processMaterial.id
      }).then(function (repos) {
        var routes = routeType === 'circulation' ? repos.results[0].circulation_routes : repos.results[0].process_steps;
        _this.props.changeRouteModalAction({
          index: index,
          processMaterial: processMaterial,
          fieldsValue: routes,
    ...
    _this.handleSaveRoute = function (fieldsValue) {
      var mydata = _this.props.status.toJS();
      var routeModal = _lodash2.default.get(mydata, 'routeModal', {});
      var routeType = routeModal.routeType,
          routeId = routeModal.routeId;
      ...
      _lodash2.default.forEach(result, function (value, index) {
        if (!value && index < count) {
          _message7.default.error('不允许跨路线，请重新设置！');
          flag = false;
          return;
        }
      });
      ...
      result = _lodash2.default.filter(result, function (value) {
        return value !== undefined;
      });
      var api = routeType === 'circulation' ? _config.apis.ProcessAPI.saveCirculationRoute : _config.apis.ProcessAPI.saveProcessRoute;
      var params = {};
      if (routeType === 'circulation') {
      ...
      (0, _api2.default)(api, params, { id: routeId }).then(function (repos) {
        _message7.default.success('保存成功！');
        _this.handleCloseRouteModal();
      });
    };

    _this.handleOpenCardModal = function (e) {
      var id = e.currentTarget.dataset.id;

      _this.props.changeCardModalAction({
        visible: true,
        id: +id
      });
    };

    _this.handleCloseCardModal = function () {
      _this.props.changeCardModalAction({
        visible: false
      });
    };

    _this.handleCreateTransferCard = function (fieldsValue) {
      (0, _api2.default)(_config.apis.ProcessAPI.addTransferCard, {
        process_material: fieldsValue.id,
        category: fieldsValue.category
      }).then(function (repos) {
        _this.handleCloseCardModal();
    ...
    _this.handleOpenWeldingSeamModal = function (e) {
      ...
      _this.props.changeWeldModalAction({
        id: +id,
        visible: true,
        fieldsValue: {}
      });
    ...
    _this.handleCloseWeldingSeamModal = function () {
      _this.props.changeWeldModalAction({
        visible: false
      });
    };

    _this.handleSaveWeldSeam = function (weldSeamId, fieldsValue) {
      var mydata = _this.props.status.toJS();
      var weldingSeamModal = _lodash2.default.get(mydata, 'weldingSeamModal', {});
      (0, _api2.default)(_config.apis.ProcessAPI.addWeldingSeam, (0, _extends3.default)({
        process_material: weldingSeamModal.id
      }, fieldsValue)).then(function (repos) {
        _message7.default.success('添加成功！');
  ...
  (0, _createClass3.default)(ProcessImport, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function buildColumns() {
      ...
      return _utils2.default.buildColumns(columns, {
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                type: 'primary',
                size: 'small',
                'data-process-material': (0, _stringify2.default)(record),
                'data-index': index,
                'data-route-type': 'circulation',
                onClick: _this2.handleOpenRouteModal
              },
              '\u7F16\u8F91'
            );
          }
        ...
        transferCard: {
          render: function render(text, record, index) {
            return record.transfer_card_id ? _react2.default.createElement(
              _button2.default,
              {
                type: 'primary',
                size: 'small'
              ...
              _react2.default.createElement(
                ...
                { to: '/process/process/transfer_card/transfer_card_detail/?id=' + record.transfer_card_id + '&category=' + record.transfer_card_name },
                '\u7F16\u8F91'
              )
            ) : _react2.default.createElement(
              _button2.default,
              {
                ...
                size: 'small',
                'data-id': record.id,
                onClick: _this2.handleOpenCardModal
              },
              '\u521B\u5EFA'
            );
          }
    ...
    value: function render() {
      ...
      var routeModal = _lodash2.default.get(mydata, 'routeModal', {});
      var weldingSeamModal = _lodash2.default.get(mydata, 'weldingSeamModal', {});
      var cardModal = _lodash2.default.get(mydata, 'cardModal', {});
      ...
      return _react2.default.createElement(
        ...
        workOrderInfo.work_order_uid && _react2.default.createElement(
          _button2.default,
          {
          ...
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/process/process/transfer_card/?work_order_uid=' + workOrderInfo.work_order_uid + '&name=' + workOrderInfo.name },
            '\u67E5\u770B\u6D41\u8F6C\u5361\u5217\u8868'
          )
        ),
        ...
        _react2.default.createElement(_CustomTable2.default, {
          ...
          rowClassName: function rowClassName(record, index) {
            return record.part_number === 0 ? 'highlight-row' : '';
          },
          onChange: this.handleChangeTable
        }),
        routeModal.visible && _react2.default.createElement(_RouteModal2.default, (0, _extends3.default)({}, routeModal, {
          onOk: this.handleSaveRoute,
          onCancel: this.handleCloseRouteModal,
          onChange: this.handleChange
        })),
        cardModal.visible && _react2.default.createElement(_CreateTransferCardModal2.default, (0, _extends3.default)({}, cardModal, {
...
ProcessImport.propTypes = {
  ...
  changeRouteModalAction: _propTypes2.default.func.isRequired,
  changeWeldModalAction: _propTypes2.default.func.isRequired,
  changeCardModalAction: _propTypes2.default.func.isRequired
};
...
var RouteModal = function (_React$Component) {
  (0, _inherits3.default)(RouteModal, _React$Component);

  function RouteModal(props) {
    (0, _classCallCheck3.default)(this, RouteModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (RouteModal.__proto__ || (0, _getPrototypeOf2.default)(RouteModal)).call(this, props));
      ...
      for (var i = 1; i <= number; i++) {
        items.push(_react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            { label: '' + prefix + i },
            getFieldDecorator('' + routePrefix + i)(_react2.default.createElement(_CustomSelect2.default, {
              allowClear: true,
              style: { width: 100 },
              list: list,
              placeholder: '----'
    ...
    _this.handleQuickEdit = function () {
      ...
      var _loop = function _loop(i) {
        var item = _lodash2.default.find(list, function (item) {
          return item.label === values[i];
        });
        if (!item) {
          _message2.default.error('请输入正确的路线！');
          return {
            v: void 0
          };
        } else {
      ...
      _this.setRouteValue(values);
    };

    _this.setRouteValue = function (values) {
      var number = _this.props.number;

      for (var i = values.length; i < number; i++) {
        values[i] = undefined;
      }
      var fieldsValue = {};
      _lodash2.default.forEach(values, function (value, index) {
        fieldsValue['' + routePrefix + (index + 1)] = value;
      });
      _this.props.form.setFieldsValue(fieldsValue);
    };

    _this.handleChangeProcessMaterials = function (e) {
  ...
  (0, _createClass3.default)(RouteModal, [{
    key: 'render',
    value: function render() {
      var inputValue = this.state.inputValue;
      var _props = this.props,
          processMaterial = _props.processMaterial,
          title = _props.title,
          visible = _props.visible,
          label = _props.label,
          onCancel = _props.onCancel;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'process-material-info' },
            _react2.default.createElement(
              _row2.default,
              { gutter: 16, key: 0 },
              _react2.default.createElement(
                ...
                { span: 6, key: 0 },
                '\u7968\u53F7\uFF1A',
                processMaterial.ticket_number
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 6, key: 1 },
                '\u56FE\u53F7\uFF1A',
                processMaterial.drawing_number
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 6, key: 2 },
                '\u540D\u79F0\uFF1A',
                processMaterial.name
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 6, key: 3 },
                '\u89C4\u683C\uFF1A',
                processMaterial.spec
              )
            ),
            _react2.default.createElement(
              _row2.default,
              ...
              _react2.default.createElement(
                ...
                { span: 6, key: 2 },
                '\u6570\u91CF\uFF1A',
                processMaterial.count
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 6, key: 3 },
                '\u5907\u6CE8\uFF1A',
                processMaterial.remark
              )
            )
          ),
          _react2.default.createElement(
...
RouteModal.propTypes = {
  processMaterial: _propTypes2.default.object.isRequired,
...
var makeFields = function makeFields(props) {
  var number = props.number,
      fieldsValue = props.fieldsValue;

  var result = {};
  for (var i = 0; i < number; i++) {
    result['' + routePrefix + (i + 1)] = _form2.default.createFormField({ value: undefined });
  }
  _lodash2.default.forEach(fieldsValue, function (value, index) {
    result['' + routePrefix + (index + 1)] = _form2.default.createFormField({ value: value + '' });
  });
...
var TableInfo = function TableInfo(props) {
  var _props$fieldsValue = props.fieldsValue,
      workOrder = _props$fieldsValue.work_order_uid,
      name = _props$fieldsValue.name,
      writer = _props$fieldsValue.writer,
      quotaClerk = _props$fieldsValue.quota_clerk,
      statistician = _props$fieldsValue.statistician,
      proofreader = _props$fieldsValue.proofreader;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { span: 2 },
        '\u5B9A\u989D\uFF1A',
        quotaClerk || _react2.default.createElement(
          _button2.default,
          {
            type: 'primary',
            size: 'small'
      ...
      _react2.default.createElement(
        ...
        { span: 2 },
        '\u7EDF\u8BA1\uFF1A',
        statistician || _react2.default.createElement(
          _button2.default,
          {
            type: 'primary',
            size: 'small'
      ...
      _react2.default.createElement(
        ...
        { span: 2 },
        '\u6821\u5BF9\uFF1A',
        proofreader || _react2.default.createElement(
          _button2.default,
          {
            type: 'primary',
            size: 'small'
...
var PROCESS_GET_LIST_DATA = 'PROCESS_GET_LIST_DATA';
var PROCESS_ADD_LIST_DATA = 'PROCESS_ADD_LIST_DATA';
var PROCESS_GET_LIBRARY_DATA = 'PROCESS_GET_LIBRARY_DATA';
var PROCESS_ADD_LIBRARY_DATA = 'PROCESS_ADD_LIBRARY_DATA';
var PROCESS_GET_MATERIALS_DATA = 'PROCESS_GET_MATERIALS_DATA';
var PROCESS_ADD_MATERIALS_DATA = 'PROCESS_ADD_MATERIALS_DATA';
var PROCESS_RESET_DATA = 'PROCESS_RESET_DATA';
var PROCESS_CHANGE_ROUTE_MODAL = 'PROCESS_CHANGE_ROUTE_MODAL';
var PROCESS_CHANGE_WELD_MODAL = 'PROCESS_CHANGE_WELD_MODAL';
var PROCESS_CHANGE_CARD_MODAL = 'PROCESS_CHANGE_CARD_MODAL';
...
function changeRouteModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function changeWeldModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function changeCardModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeRouteModalAction: changeRouteModalAction,
  changeWeldModalAction: changeWeldModalAction,
  changeCardModalAction: changeCardModalAction
...
function Process() {
  ...
  var map = {
    PROCESS_GET_LIST_DATA: function PROCESS_GET_LIST_DATA() {
      return state.set('loading', true);
    },
    PROCESS_ADD_LIST_DATA: function PROCESS_ADD_LIST_DATA() {
    ...
    PROCESS_ADD_LIBRARY_DATA: function PROCESS_ADD_LIBRARY_DATA() {
      var data = action.payload.data;
    ...
    PROCESS_ADD_MATERIALS_DATA: function PROCESS_ADD_MATERIALS_DATA() {
      var _action$payload = action.payload,
          weldingMaterials = _action$payload.weldingMaterials,
          fluxMaterials = _action$payload.fluxMaterials;
    ...
    PROCESS_RESET_DATA: function PROCESS_RESET_DATA() {
      return state.merge({
        workOrderInfo: {},
        list: []
      });
    },
    PROCESS_CHANGE_ROUTE_MODAL: function PROCESS_CHANGE_ROUTE_MODAL() {
      return state.mergeIn(['routeModal'], action.payload);
    },
    PROCESS_CHANGE_WELD_MODAL: function PROCESS_CHANGE_WELD_MODAL() {
      return state.mergeIn(['weldingSeamModal'], action.payload);
    },
    PROCESS_CHANGE_CARD_MODAL: function PROCESS_CHANGE_CARD_MODAL() {
...
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, _ref2, _ref3, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PROCESS_GET_LIST_DATA);

        case 3:
          _ref = _context.sent;
          _ref$payload = _ref.payload;
          payload = _ref$payload === undefined ? {} : _ref$payload;
          callback = payload.callback, params = payload.params;
          _context.next = 9;
          return [(0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getProcessMaterials, params)];
...
function getLibrarySaga(type, body) {
  var _ref4, _ref4$payload, _payload, _callback, _payload$params, _params, _data;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(PROCESS_GET_LIBRARY_DATA);

        case 3:
          _ref4 = _context2.sent;
          _ref4$payload = _ref4.payload;
          _payload = _ref4$payload === undefined ? {} : _ref4$payload;
          _callback = _payload.callback, _payload$params = _payload.params, _params = _payload$params === undefined ? {} : _payload$params;
          _context2.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getProcessLibraries, _params);
        ...
        case 9:
          ...
          _context2.next = 13;
          return (0, _effects.put)(addLibraryDataAction({ data: _data }));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _effects.take)(PROCESS_GET_MATERIALS_DATA);
