...
var _modules = __webpack_require__(948);

var _MaterialSummarize = __webpack_require__(1583);

var _MaterialSummarize2 = _interopRequireDefault(_MaterialSummarize);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_MaterialSummarize2.default));
...
var FilterBar = function (_React$Component) {
  (0, _inherits3.default)(FilterBar, _React$Component);

  function FilterBar(props) {
    (0, _classCallCheck3.default)(this, FilterBar);

    var _this = (0, _possibleConstructorReturn3.default)(this, (FilterBar.__proto__ || (0, _getPrototypeOf2.default)(FilterBar)).call(this, props));
    ...
    _this.state = {};
    _const.MATERIAL_CATEGORY_LIST.shift();
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('inventory_type', { initialValue: 0 })(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u8BF7\u9009\u62E9\u6750\u6599\u7C7B\u578B\u72B6\u6001',
            list: _const.MATERIAL_CATEGORY_LIST
          }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('process_material_name')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u8BF7\u8F93\u5165\u7269\u6599\u540D\u79F0' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _popconfirm = __webpack_require__(1350);
...
var _FilterBar = __webpack_require__(1582);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _PurchaseOrder = __webpack_require__(1586);
...
var _OrderModal = __webpack_require__(1584);

var _OrderModal2 = _interopRequireDefault(_OrderModal);

var _OrderSelectModal = __webpack_require__(1585);

var _OrderSelectModal2 = _interopRequireDefault(_OrderSelectModal);

__webpack_require__(1724);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns0 = ['add', 'sub_order', 'name_order', 'spec_order', 'material_order', 'count_order', 'weight', 'total_weight', 'material_status', 'action'];
var columns1 = ['add', 'sub_order', 'name_order', 'spec_order', 'drawing_number_order', 'material_order', 'count_order', 'total_weight', 'material_status', 'action'];
var columns2 = ['add', 'sub_order', 'name_order', 'spec_order', 'drawing_number_order', 'material_order', 'count_order', 'total_weight', 'material_status', 'action'];
var columns3 = ['add', 'sub_order', 'name_order', 'spec_order', 'drawing_number_order', 'material_order', 'count_order', 'total_weight', 'material_status', 'action'];
var columns4 = ['add', 'sub_order', 'name_order', 'spec_order', 'material_order', 'quota', 'remark_order', 'material_status', 'action'];
var columns5 = ['add', 'sub_order', 'name_order', 'drawing_number_order', 'ticket_number_order', 'material_order', 'count_order', 'weight', 'total_weight', 'material_status', 'action'];
...
var MaterialSummarize = function (_React$Component) {
  (0, _inherits3.default)(MaterialSummarize, _React$Component);

  function MaterialSummarize(props) {
    (0, _classCallCheck3.default)(this, MaterialSummarize);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MaterialSummarize.__proto__ || (0, _getPrototypeOf2.default)(MaterialSummarize)).call(this, props));
    ...
    _this.handleFinished = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateProcurementMaterial, { finished: true }, { id: id }).then(function (repos) {
          _message8.default.success('操作成功！');
          _this.updatelist();
        });
      };
    };

    _this.handleChangeCheckbox = function (record, index) {
      return function (e) {
        var checked = e.target.checked;
        var _this$state = _this.state,
            checkedBoolList = _this$state.checkedBoolList,
    ...
    _this.handleOpenOrderModal = function (id, uid) {
      var list = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

      var query = _queryString2.default.parse(_this.props.location.search);
      if (_lodash2.default.isUndefined(query.inventory_type)) {
        query.inventory_type = 0;
      }
      var type = +query.inventory_type < 2 ? 'type0' : 'type1';
      var params = {
        visible: true,
        list: [],
        type: type
      ...
      if (!_lodash2.default.isUndefined(id)) {
        (0, _api2.default)(_config.apis.PurchaseAPI.getProcurementMaterials, { purchase_order_uid: uid }).then(function (repos) {
          list = _lodash2.default.map(list, function (item) {
          ...
          params.id = id;
          params.uid = uid;
          _this.props.changeOrderModalAction(params);
        });
      } else {
        _this.props.changeOrderModalAction(params);
      }
    ...
    _this.handleCloseOrderModal = function () {
      _this.props.changeOrderModalAction({
        visible: false
      });
    };

    _this.handleDelete = function (id) {
      (0, _api2.default)(_config.apis.PurchaseAPI.deletePurchaseOrder, {}, { id: id }).then(function (repos) {
        _message8.default.success('删除成功！');
        _this.handleCloseOrderModal();
        _this.updatelist();
      });
    };

    _this.handleSaveOrder = function (id, uid) {
      var list = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

      if (_lodash2.default.isUndefined(id)) {
        (0, _api2.default)(_config.apis.PurchaseAPI.addPurchaseOrders, { uid: uid }).then(function (repos) {
          _message8.default.success('订购单创建成功！');
          _this.handleCloseOrderModal();
          _this.updatelist();
        });
      } else {
        (0, _api2.default)(_config.apis.PurchaseAPI.updatePurchaseOrder, { uid: uid }, { id: id }).then(function (repos) {
          _message8.default.success('订购单修改成功！');
          _this.handleCloseOrderModal();
          _this.updatelist();
        });
        _lodash2.default.forEach(list, function (item) {
          (0, _api2.default)(_config.apis.PurchaseAPI.updateProcurementMaterial, { purchase_order: id }, { id: item.id });
        });
        _this.setState({
          checkedList: []
        });
    ...
    _this.handleAddToOrder = function () {
      var checkedList = _this.state.checkedList;

      if (checkedList.length === 0) {
        _message8.default.warning('请先选择要添加的采购物料！');
        return;
      }
      _this.props.changeOrderSelectModalAction({
        visible: true
      });
    };

    _this.handleCloseOrderSelectModal = function (e) {
      _this.props.changeOrderSelectModalAction({
        visible: false
      });
    };

    _this.handleChangeToOrderModal = function (id, uid) {
      var checkedList = _this.state.checkedList;

      _this.handleCloseOrderSelectModal();
      _this.handleOpenOrderModal(id, uid, checkedList);
    };

    _this.handleAddToExecution = function () {
      var checkedList = _this.state.checkedList;
      ...
      _lodash2.default.forEach(checkedList, function (item) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateProcurementMaterial, { status: 3 }, { id: item.id });
      });
    };
  ...
  (0, _createClass3.default)(MaterialSummarize, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var query = this._query();
      this.fetchData(query, function (materialData, purchaseOrderData) {
        _this2.setState({
          checkedBoolList: _lodash2.default.map(materialData.results, function (item) {
            return false;
          })
        }, function () {
          var columns = _this2.buildColumns(typeMap[query.inventory_type].columns);
          _this2.props.addListDataAction({ materialData: materialData, purchaseOrderData: purchaseOrderData, columns: columns });
        });
      });
    }
  }, {
    key: 'fetchData',
    value: function fetchData(query, callback) {
    ...
    value: function buildColumns(columns) {
      ...
      var checkedBoolList = this.state.checkedBoolList;

      return _utils2.default.buildColumns(columns, {
        add: {
          render: function render(text, record, index) {
            return record.status === 1 ? _react2.default.createElement(_checkbox2.default, {
              checked: checkedBoolList[index],
              onChange: _this3.handleChangeCheckbox(record, index)
            }) : '';
          }
        },
        action: {
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              {
                title: '\u786E\u5B9A\u5B8C\u6210\u5417\uFF1F',
                onConfirm: _this3.handleFinished(record.id),
                okText: '\u786E\u5B9A',
                cancelText: '\u53D6\u6D88'
              },
              _react2.default.createElement(
    ...
    value: function updatelist() {
      ...
      this.fetchData(query, function (materialData, purchaseOrderData) {
        _this4.setState({
          ...
          var columns = _this4.buildColumns(typeMap[query.inventory_type].columns);
          _this4.props.addListDataAction({ materialData: materialData, purchaseOrderData: purchaseOrderData, columns: columns });
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var purchaseOrderList = _lodash2.default.get(mydata, 'purchaseOrderList', []);
      var loading = _lodash2.default.get(mydata, 'loading');
      var pagination = _lodash2.default.get(mydata, 'pagination', {});
      var columns = _lodash2.default.get(mydata, 'columns', {});
      var orderModal = _lodash2.default.get(mydata, 'orderModal', {});
      var orderSelectModal = _lodash2.default.get(mydata, 'orderSelectModal', {});
      return _react2.default.createElement(
        'div',
        { className: 'material-summarize' },
        ...
        _react2.default.createElement(
          'div',
          { className: 'material-operation-area' },
          _react2.default.createElement(
            _button2.default,
            {
              type: 'primary',
        ...
        orderModal.visible && _react2.default.createElement(_OrderModal2.default, (0, _extends3.default)({}, orderModal, {
          onSave: this.handleSaveOrder,
          onDelete: this.handleDelete,
          onOk: this.handleCloseOrderModal,
          onCancel: this.handleCloseOrderModal
        })),
        orderSelectModal.visible && _react2.default.createElement(_OrderSelectModal2.default, (0, _extends3.default)({}, orderSelectModal, {
          list: purchaseOrderList,
...
MaterialSummarize.propTypes = {
  ...
  addListDataAction: _propTypes2.default.func.isRequired,
  changeOrderModalAction: _propTypes2.default.func.isRequired,
  changeOrderSelectModalAction: _propTypes2.default.func.isRequired
};

exports.default = MaterialSummarize;
...
var columns0 = ['sub_order', 'name_order', 'spec_order', 'material_order', 'count_order', 'weight', 'total_weight', 'remark_order', 'material_status'];
var columns1 = ['sub_order', 'name_order', 'ticket_number_order', 'drawing_number_order', 'material_order', 'count_order', 'weight', 'total_weight', 'remark_order', 'material_status'];

var OrderModal = function (_React$Component) {
  (0, _inherits3.default)(OrderModal, _React$Component);

  function OrderModal(props) {
    (0, _classCallCheck3.default)(this, OrderModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (OrderModal.__proto__ || (0, _getPrototypeOf2.default)(OrderModal)).call(this, props));
    ...
    _this.handleSave = function (e) {
      var _this$props = _this.props,
          ...
          id = _this$props.id,
          addList = _this$props.addList;
      var uid = _this.state.uid;

      if (_lodash2.default.isUndefined(uid)) {
        _message3.default.warning('请输入订购单编号！');
        return;
      }
  ...
  (0, _createClass3.default)(OrderModal, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      this.setState({
        uid: this.props.uid
    ...
    value: function buildColumns() {
      ...
      var columns = type === 'type0' ? columns0 : columns1;
      return _utils2.default.buildColumns(columns, {});
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _lodash2.default.isUndefined(id) ? '创建订购单' : '保存订购单'
          ),
...
OrderModal.propTypes = {
  ...
  addList: _propTypes2.default.array,
...
var OrderSelectModal = function (_React$Component) {
  (0, _inherits3.default)(OrderSelectModal, _React$Component);

  function OrderSelectModal(props) {
    (0, _classCallCheck3.default)(this, OrderSelectModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (OrderSelectModal.__proto__ || (0, _getPrototypeOf2.default)(OrderSelectModal)).call(this, props));

    _this.handleChange = function (value, item) {
      _this.setState({
        id: +value,
        uid: item.label
      });
  ...
  (0, _createClass3.default)(OrderSelectModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u8981\u52A0\u5165\u7684\u8BA2\u8D2D\u5355' }, formItemLayout),
            getFieldDecorator('purchase_order', fieldsConfig['purchase_order'])(_react2.default.createElement(_CustomSelect2.default, {
              list: list,
...
var WrappedForm = _form2.default.create()(OrderSelectModal);
...
var PurchaseOrder = function (_React$Component) {
  (0, _inherits3.default)(PurchaseOrder, _React$Component);
  ...
  function PurchaseOrder(props) {
    ...
    _this.handleCheck = function (e) {
      var _this$state = _this.state,
          purchaseOrderId = _this$state.purchaseOrderId,
          purchaseOrderUid = _this$state.purchaseOrderUid;
      var onOk = _this.props.onOk;

      if (_lodash2.default.isUndefined(purchaseOrderId)) {
        _message3.default.warning('请先选择一个订购单编号！');
        return;
      }
  ...
  (0, _createClass3.default)(PurchaseOrder, [{
    ...
    value: function render() {
      ...
      var purchaseOrderUid = this.state.purchaseOrderUid;

      return _react2.default.createElement(
        'div',
        { className: 'material-summarize-purchase-order' },
        _react2.default.createElement(_CustomSelect2.default, {
          list: list,
...
var SUMMARIZE_GET_LIST_DATA = 'SUMMARIZE_GET_LIST_DATA';
var SUMMARIZE_ADD_LIST_DATA = 'SUMMARIZE_ADD_LIST_DATA';
var SUMMARIZE_CHANGE_ORDER_MODAL = 'SUMMARIZE_CHANGE_ORDER_MODAL';
var SUMMARIZE_CHANGE_ORDER_SELECT_MODAL = 'SUMMARIZE_CHANGE_ORDER_SELECT_MODAL';
var PAGE_SIZE = 10;
...
function changeOrderModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function changeOrderSelectModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeOrderModalAction: changeOrderModalAction,
  changeOrderSelectModalAction: changeOrderSelectModalAction
...
function MaterialSummarize() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    SUMMARIZE_GET_LIST_DATA: function SUMMARIZE_GET_LIST_DATA() {
    ...
    SUMMARIZE_ADD_LIST_DATA: function SUMMARIZE_ADD_LIST_DATA() {
      var _action$payload = action.payload,
          materialData = _action$payload.materialData,
          purchaseOrderData = _action$payload.purchaseOrderData,
          columns = _action$payload.columns;

      purchaseOrderData = _lodash2.default.map(purchaseOrderData.results, function (item) {
        return {
          value: item.id,
          label: item.uid
        };
      ...
      return state.mergeIn(['pagination'], { total: materialData.count }).merge(params);
    },
    SUMMARIZE_CHANGE_ORDER_MODAL: function SUMMARIZE_CHANGE_ORDER_MODAL() {
      return state.mergeIn(['orderModal'], action.payload);
    },
    SUMMARIZE_CHANGE_ORDER_SELECT_MODAL: function SUMMARIZE_CHANGE_ORDER_SELECT_MODAL() {
...
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, inventoryType, category, _ref2, _ref3, materialData, purchaseOrderData;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(SUMMARIZE_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 12;
          return [(0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getProcurementMaterialsWithStatus, params), (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getPurchaseOrders, { category: category })];

        case 12:
          _ref2 = _context.sent;
          _ref3 = (0, _slicedToArray3.default)(_ref2, 2);
          materialData = _ref3[0];
          purchaseOrderData = _ref3[1];

          callback && callback(materialData, purchaseOrderData);
          _context.next = 19;
          return (0, _effects.put)(addListDataAction({ materialData: materialData, purchaseOrderData: purchaseOrderData }));
