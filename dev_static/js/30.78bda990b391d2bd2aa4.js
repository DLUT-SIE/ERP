...
var _modules = __webpack_require__(960);

var _SupplierSelect = __webpack_require__(1614);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_SupplierSelect2.default));
...
var _PurchaseOrderRawTable = __webpack_require__(1398);

var _PurchaseOrderRawTable2 = _interopRequireDefault(_PurchaseOrderRawTable);

var _PurchaseOrderNormalTable = __webpack_require__(1396);

var _PurchaseOrderNormalTable2 = _interopRequireDefault(_PurchaseOrderNormalTable);

var _PurchaseOrderWeldTable = __webpack_require__(1400);

var _PurchaseOrderWeldTable2 = _interopRequireDefault(_PurchaseOrderWeldTable);
...
var OrderForm = function (_React$Component) {
  (0, _inherits3.default)(OrderForm, _React$Component);
  ...
  (0, _createClass3.default)(OrderForm, [{
    ...
    value: function componentDidMount() {
      ...
      var bidId = this.props.bidId;

      if (!_lodash2.default.isUndefined(bidId)) {
        (0, _api2.default)(_config.apis.PurchaseAPI.getBiddingSheet, {}, { id: bidId }).then(function (bid) {
          (0, _api2.default)(_config.apis.PurchaseAPI.getPurchaseOrder, {}, { id: bid.purchase_order }).then(function (order) {
            _this2.setState({
              order: order
            });
          });
          (0, _api2.default)(_config.apis.PurchaseAPI.getProcurementMaterials, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var orderId = nextProps.orderId,
          orderUid = nextProps.orderUid;

      if (!_lodash2.default.isUndefined(orderId) && nextProps.orderId !== this.props.orderId) {
        (0, _api2.default)(_config.apis.PurchaseAPI.getPurchaseOrder, {}, { id: orderId }).then(function (order) {
          _this3.setState({
            order: order
          });
        });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'check-operation-area' },
          _react2.default.createElement(
            'span',
        ...
        show && order.category === 0 && _react2.default.createElement(_PurchaseOrderRawTable2.default, {
          order: order,
          list: list
        }),
        show && order.category === 1 && _react2.default.createElement(_PurchaseOrderNormalTable2.default, {
          order: order,
          list: list
        }),
        show && order.category === 2 && _react2.default.createElement(_PurchaseOrderWeldTable2.default, {
          order: order,
          list: list
        })
      );
...
OrderForm.propTypes = {
  bidId: _propTypes2.default.number,
  orderId: _propTypes2.default.number,
  orderUid: _propTypes2.default.string
};
...
var _OrderForm = __webpack_require__(1393);
...
var getProcurementMaterialsTrs = function getProcurementMaterialsTrs(list) {
  var materialTrs = _lodash2.default.map(list, function (item, index) {
    var processMaterial = item.process_material;

    return _react2.default.createElement(
      'tr',
      { className: 'material-tr', key: index },
      _react2.default.createElement(
        'td',
        { className: 'name-spec-td', colSpan: 4 },
        processMaterial && processMaterial.name + ' ' + processMaterial.spec
      ),
      _react2.default.createElement(
        'td',
        { className: 'schematic-index-td', colSpan: 2 },
      ...
      _react2.default.createElement(
        'td',
        { className: 'finished-td' },
        item.finished ? '已结束' : '未结束'
      ),
      _react2.default.createElement(
        'td',
        { className: 'delivery-dt-td', colSpan: 3 },
        item.delivery_dt
      ),
      _react2.default.createElement(
        'td',
        { className: 'remark-td', colSpan: 2 },
...
var PurchaseOrderNormalTable = function PurchaseOrderNormalTable(props) {
  var order = props.order,
      list = props.list;

  return _react2.default.createElement(
    'div',
    { className: 'supplier-select-purchase-order-normal' },
    _react2.default.createElement(
      'p',
      { className: 'title-p' },
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      'table',
      { className: 'purchase-order-normal-table', cellSpacing: 0, cellPadding: 0 },
      _react2.default.createElement(
        'thead',
        null,
        _react2.default.createElement(
          'tr',
          { className: 'delivery-tr' },
          _react2.default.createElement(
            'td',
            { className: 'delivery-td', colSpan: 4 },
            '\u91C7\u8D2D\u6280\u672F\u6761\u4EF6\u53F7/\u4FEE\u8BA2\u53F7'
          ),
          _react2.default.createElement(
            'td',
            { className: 'delivery-value-td', colSpan: 11 },
            order.revised_number
          )
        ),
        _react2.default.createElement(
          'tr',
          { className: 'purchase-order-info-tr' },
          _react2.default.createElement(
            'td',
            { className: 'name-spec-td', colSpan: 4 },
            '\u540D\u79F0\u53CA\u89C4\u683C'
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'work-order-value-td' },
            order.work_order
          ),
          _react2.default.createElement(
            'td',
            { className: 'writer-date-td', colSpan: 2 },
            '\u7F16\u5236',
          ...
          _react2.default.createElement(
            'td',
            { className: 'writer-date-value-td', colSpan: 2 },
            order.lister,
            ' ',
            order.list_dt
          ),
          _react2.default.createElement(
            'td',
            { className: 'review-date-td', colSpan: 2 },
            '\u5BA1\u6838',
            _react2.default.createElement('br', null),
            '\u65E5\u671F'
          ),
          _react2.default.createElement(
            'td',
            { className: 'review-date-value-td', colSpan: 2 },
            order.chief,
            ' ',
            order.audit_date
          ),
          _react2.default.createElement(
            'td',
            { className: 'approve-date-td', colSpan: 2 },
            '\u6279\u51C6',
            _react2.default.createElement('br', null),
            '\u65E5\u671F'
          ),
          _react2.default.createElement(
            'td',
            { className: 'approve-date-value-td', colSpan: 2 },
            order.approver,
            ' ',
            order.approve_dt
          )
...
PurchaseOrderNormalTable.propTypes = {
  order: _propTypes2.default.object.isRequired,
  list: _propTypes2.default.array.isRequired
};

exports.default = PurchaseOrderNormalTable;
...
var _PurchaseOrderNormalTable = __webpack_require__(1395);

var _PurchaseOrderNormalTable2 = _interopRequireDefault(_PurchaseOrderNormalTable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _PurchaseOrderNormalTable2.default;
...
var getProcurementMaterialsTrs = function getProcurementMaterialsTrs(list) {
  var materialTrs = _lodash2.default.map(list, function (item, index) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'td',
        { className: 'material-td', colSpan: 3 },
        processMaterial && processMaterial.material
      ),
      _react2.default.createElement(
        'td',
        { className: 'spec-td', colSpan: 3 },
      ...
      _react2.default.createElement(
        'td',
        { className: 'purchase-td', colSpan: 3 },
        item.total_weight
      ),
      _react2.default.createElement(
        'td',
        { className: 'finished-td', colSpan: 2 },
        item.finished ? '已结束' : '未结束'
      ),
      _react2.default.createElement(
        'td',
        { className: 'remark-td', colSpan: 3 },
        processMaterial && processMaterial.remark
      )
    );
  });
...
var PurchaseOrderRawTable = function PurchaseOrderRawTable(props) {
  var order = props.order,
      list = props.list;

  return _react2.default.createElement(
    'div',
    { className: 'supplier-select-purchase-order-raw' },
    _react2.default.createElement(
      'p',
      { className: 'title-p' },
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      'table',
      { className: 'purchase-order-raw-table', cellSpacing: 0, cellPadding: 0 },
      _react2.default.createElement(
        'thead',
        null,
        _react2.default.createElement(
          'tr',
          { className: 'revised-number-tr' },
          _react2.default.createElement(
            'td',
            { colSpan: 5, className: 'revised-number-td' },
            '\u91C7\u8D2D\u6280\u672F\u6761\u4EF6\u53F7/\u4FEE\u8BA2\u53F7'
          ),
          _react2.default.createElement(
            'td',
            { colSpan: 4, className: 'revised-number-value-td' },
            order.revised_number
          ),
          _react2.default.createElement(
            'td',
            { colSpan: 5, className: 'order-number-td' },
            '\u8BA2\u8D2D\u5355\u7F16\u53F7'
          ),
          _react2.default.createElement(
            'td',
            { colSpan: 4, className: 'order-number-value-td' },
            order.uid
          )
        ),
        _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'foreign-purchasing-td', colSpan: 5 },
            '\u5916\u91C7\u79D1\u957F\uFF1A',
            order.chief,
            ' ',
            order.audit_date
          ...
          _react2.default.createElement(
            'td',
            { className: 'approve-td', colSpan: 5 },
            '\u6279\u51C6\uFF1A',
            order.approver,
            ' ',
            order.approve_dt
...
exports.default = PurchaseOrderRawTable;
...
var _PurchaseOrderRawTable = __webpack_require__(1397);

var _PurchaseOrderRawTable2 = _interopRequireDefault(_PurchaseOrderRawTable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _PurchaseOrderRawTable2.default;
...
var PurchaseOrderWeldTable = function PurchaseOrderWeldTable(props) {
  var order = props.order,
      list = props.list;

  return _react2.default.createElement(
    'div',
    { className: 'supplier-select-purchase-order-weld' },
    _react2.default.createElement(
      'p',
      { className: 'title-p' },
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      'table',
      { className: 'purchase-order-weld-table', cellSpacing: 0, cellPadding: 0 },
      _react2.default.createElement(
        'thead',
        null,
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'delivery-td', colSpan: 3 },
            '\u91C7\u8D2D\u6280\u672F\u6761\u4EF6\u53F7/\u4FEE\u8BA2\u53F7'
          ),
          _react2.default.createElement(
            'td',
            { className: 'delivery-value-td', colSpan: 4 },
            order.revised_number
          ),
          _react2.default.createElement(
            'td',
            { className: 'number-td', colSpan: 3 },
            '\u91C7\u8D2D\u5355\u7F16\u53F7'
          ),
          _react2.default.createElement(
            'td',
            { className: 'number-value-td', colSpan: 3 },
            order.uid
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'work-order-td', colSpan: 3 },
            '\u5DE5\u4F5C\u4EE4\u53F7\uFF1A'
          ),
          _react2.default.createElement(
            'td',
            { className: 'work-order-value-td', colSpan: 4 },
            order.work_order
          ),
          _react2.default.createElement(
            'td',
            { className: 'list-dt-td', colSpan: 3 },
            '\u7F16\u5236\u65E5\u671F\uFF1A'
          ),
          _react2.default.createElement(
            'td',
            { className: 'list-dt-value-td', colSpan: 3 },
            order.list_dt
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'delivery-dt-td', colSpan: 2 },
            _react2.default.createElement(
              'b',
              null,
              '\u4EA4\u8D27\u671F'
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            { className: 'writer-td', colSpan: 3 },
            '\u7F16\u5236\uFF1A'
          ),
          _react2.default.createElement(
            'td',
            { className: 'writer-value-td', colSpan: 2 },
            order.lister
          ),
          _react2.default.createElement(
            'td',
            { className: 'review-td', colSpan: 2 },
            '\u5BA1\u6838\uFF1A'
          ),
          _react2.default.createElement(
            'td',
            { className: 'review-value-td', colSpan: 2 },
            order.chief
          ),
          _react2.default.createElement(
            'td',
            { className: 'approve-td', colSpan: 2 },
            '\u6279\u51C6\uFF1A'
          ),
          _react2.default.createElement(
            'td',
            { className: 'approve-value-td', colSpan: 2 },
            order.approver
          )
        )
      )
...
exports.default = PurchaseOrderWeldTable;
...
var _PurchaseOrderWeldTable = __webpack_require__(1399);

var _PurchaseOrderWeldTable2 = _interopRequireDefault(_PurchaseOrderWeldTable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _PurchaseOrderWeldTable2.default;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('name')(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u4F9B\u5E94\u5546\u540D\u79F0' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var columns = ['pretty_inventory_type', 'name_spec', 'material_mark_quotation', 'unit_price', 'unit', 'price'];

var QuotationModal = function (_React$Component) {
  (0, _inherits3.default)(QuotationModal, _React$Component);

  function QuotationModal(props) {
    (0, _classCallCheck3.default)(this, QuotationModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (QuotationModal.__proto__ || (0, _getPrototypeOf2.default)(QuotationModal)).call(this, props));

    _this._columns = _this.buildColumns();
    return _this;
  }

  (0, _createClass3.default)(QuotationModal, [{
    key: 'buildColumns',
...
exports.default = QuotationModal;
...
var _message4 = __webpack_require__(29);
...
var _OrderForm = __webpack_require__(1394);

var _OrderForm2 = _interopRequireDefault(_OrderForm);

var _FilterBar = __webpack_require__(1612);
...
var _QuotationModal = __webpack_require__(1613);

var _QuotationModal2 = _interopRequireDefault(_QuotationModal);

__webpack_require__(1747);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['selected', 'supplier_uid', 'supplier_name', 'supplier_file', 'price'];

var SupplierSelect = function (_React$Component) {
  (0, _inherits3.default)(SupplierSelect, _React$Component);

  function SupplierSelect(props) {
    (0, _classCallCheck3.default)(this, SupplierSelect);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SupplierSelect.__proto__ || (0, _getPrototypeOf2.default)(SupplierSelect)).call(this, props));
    ...
    _this.handleOpenQuotationModal = function (e) {
      var id = e.target.dataset.id;

      (0, _api2.default)(_config.apis.PurchaseAPI.getSupplierQuotations, { supplier: +id }).then(function (repos) {
        _this.props.changeQuotationModalAction({
          visible: true,
          list: repos.results
        });
      });
    ...
    _this.handleCloseQuotationModal = function () {
      _this.props.changeQuotationModalAction({
        visible: false
      });
    };

    _this.handleChangeCheckbox = function (e) {
    ...
    _this.handleConfirm = function () {
      ...
      (0, _api2.default)(_config.apis.PurchaseAPI.addSupplyRelationship, {
        suppliers: checkedList,
        bidding_sheet: _this._id
      }).then(function (repos) {
        _message5.default.success('选择成功！');
        _this.updatelist();
      });
    };

    _this.handleReset = function () {
      (0, _api2.default)(_config.apis.PurchaseAPI.resetSupplyRelationships, {}, { id: _this._id }).then(function (repos) {
        _message5.default.success('重置成功！');
        _this.updatelist();
      });
    };

    _this.handleSubmit = function () {
      (0, _api2.default)(_config.apis.PurchaseAPI.updateBiddingSheet, { status: 2 }, { id: _this._id }).then(function () {
        _message5.default.success('操作成功！');
  ...
  (0, _createClass3.default)(SupplierSelect, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        selected: {
          render: function render(text, record, index) {
            return record.selected ? '已选择' : _react2.default.createElement(_checkbox2.default, {
              id: record.id,
              onChange: _this2.handleChangeCheckbox
            });
          }
        },
        supplier_file: {
          render: function render(text, record, index) {
            return record.docs.length > 0 ? _react2.default.createElement(
              'div',
              null,
              _lodash2.default.map(record.docs, function (doc, index) {
                return _react2.default.createElement(
                  'a',
                  {
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                size: 'small',
                'data-id': record.id,
                onClick: _this2.handleOpenQuotationModal
              },
              '\u62A5\u4EF7'
            );
          }
    ...
    value: function render() {
      ...
      var quotationModal = _lodash2.default.get(mydata, 'quotationModal', {});
      return _react2.default.createElement(
        'div',
        ...
        quotationModal.visible && _react2.default.createElement(_QuotationModal2.default, (0, _extends3.default)({}, quotationModal, {
...
SupplierSelect.propTypes = {
  ...
  changeQuotationModalAction: _propTypes2.default.func.isRequired
};

exports.default = SupplierSelect;
...
var SUPPLIERSELECT_GET_LIST_DATA = 'SUPPLIERSELECT_GET_LIST_DATA';
var SUPPLIERSELECT_ADD_LIST_DATA = 'SUPPLIERSELECT_ADD_LIST_DATA';
var SUPPLIERSELECT_CHANGE_QUOTATION_MODAL = 'SUPPLIERSELECT_CHANGE_QUOTATION_MODAL';
var PAGE_SIZE = 10;
...
function changeQuotationModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeQuotationModalAction: changeQuotationModalAction
...
function SupplierSelect() {
  ...
  var map = {
    SUPPLIERSELECT_GET_LIST_DATA: function SUPPLIERSELECT_GET_LIST_DATA() {
    ...
    SUPPLIERSELECT_ADD_LIST_DATA: function SUPPLIERSELECT_ADD_LIST_DATA() {
      var data = action.payload.data;

      return state.mergeIn(['pagination'], { total: data.count }).merge({
        list: data.results,
        loading: false
      });
    },
    SUPPLIERSELECT_CHANGE_QUOTATION_MODAL: function SUPPLIERSELECT_CHANGE_QUOTATION_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(SUPPLIERSELECT_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getSuppliersWithBiddingSheet, params);
