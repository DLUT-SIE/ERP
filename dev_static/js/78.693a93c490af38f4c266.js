...
var columns = ['create_dt', 'keeper', 'action'];
var formItemLayout = {
  labelCol: { span: 3 },
  wrapperCol: { span: 8 }
};
...
var BasicDataHumitureRecord = function (_React$Component) {
  (0, _inherits3.default)(BasicDataHumitureRecord, _React$Component);

  function BasicDataHumitureRecord(props) {
    (0, _classCallCheck3.default)(this, BasicDataHumitureRecord);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BasicDataHumitureRecord.__proto__ || (0, _getPrototypeOf2.default)(BasicDataHumitureRecord)).call(this, props));

    _this.handleSave = function (fieldsValue) {
      (0, _api2.default)(_config.apis.InventoryAPI.updateWeldHumitureRecord, fieldsValue, { id: fieldsValue.id }).then(function (repos) {
  ...
  (0, _createClass3.default)(BasicDataHumitureRecord, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _form2.default,
        { className: 'basic-data-humiture-record' },
        _react2.default.createElement(
          FormItem,
          (0, _extends3.default)({ label: '\u8981\u6C42\u6E29\u5EA6' }, formItemLayout),
          getFieldDecorator('requireTemp', fieldsConfig['requireTemp'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u8981\u6C42\u6E29\u5EA6' }))
        ),
        _react2.default.createElement(
          FormItem,
          (0, _extends3.default)({ label: '\u8981\u6C42\u6E7F\u5EA6' }, formItemLayout),
          getFieldDecorator('requireHumid', fieldsConfig['requireHumid'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u8981\u6C42\u6E29\u5EA6' }))
        ),
        _react2.default.createElement(
          FormItem,
          formItemLayout2,
          _react2.default.createElement(
            _button2.default,
            { className: 'float-right', type: 'success' },
            '\u786E\u5B9A'
          )
        )
      );
  ...
  return BasicDataHumitureRecord;
...
exports.default = BasicDataHumitureRecord;
...
var BASIC_DATA_HUMITURE_RECORD_GET_LIST_DATA = 'BASIC_DATA_HUMITURE_RECORD_GET_LIST_DATA';
var BASIC_DATA_HUMITURE_RECORD_ADD_LIST_DATA = 'BASIC_DATA_HUMITURE_RECORD_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function BasicDataHumitureRecord() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    BASIC_DATA_HUMITURE_RECORD_GET_LIST_DATA: function BASIC_DATA_HUMITURE_RECORD_GET_LIST_DATA() {
    ...
    BASIC_DATA_HUMITURE_RECORD_ADD_LIST_DATA: function BASIC_DATA_HUMITURE_RECORD_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(BASIC_DATA_HUMITURE_RECORD_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.InventoryAPI.getWeldHumitureRecord, params);
...
var _modules = __webpack_require__(891);

var _BasicDataHumitureRecord = __webpack_require__(1436);

var _BasicDataHumitureRecord2 = _interopRequireDefault(_BasicDataHumitureRecord);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_BasicDataHumitureRecord2.default));
