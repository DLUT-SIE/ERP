...
var _modules = __webpack_require__(958);

var _Supplier = __webpack_require__(1609);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Supplier2.default));
...
var _SupplierModal = __webpack_require__(1610);

var _SupplierModal2 = _interopRequireDefault(_SupplierModal);

__webpack_require__(1744);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['supplier_uid', 'supplier_name', 'supplier_file', 'quotation', 'upload_supplier_file', 'action'];

var Supplier = function (_React$Component) {
  (0, _inherits3.default)(Supplier, _React$Component);

  function Supplier(props) {
    (0, _classCallCheck3.default)(this, Supplier);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Supplier.__proto__ || (0, _getPrototypeOf2.default)(Supplier)).call(this, props));
    ...
    _this.handleOpenSupplierModal = function (e) {
      var fieldsValue = e.target.dataset.fieldsValue;

      fieldsValue = fieldsValue ? JSON.parse(fieldsValue) : {};
      _this.props.changeSupplierModalAction({
        visible: true,
        fieldsValue: fieldsValue
      });
    };

    _this.handleCloseSupplierModal = function () {
      _this.props.changeSupplierModalAction({
        visible: false
      });
    };

    _this.handleSaveSupplier = function (id, fieldsValue) {
      if (_lodash2.default.isUndefined(id)) {
        (0, _api2.default)(_config.apis.PurchaseAPI.addSupplier, fieldsValue).then(function (repos) {
          _message5.default.success('添加成功！');
          _this.handleCloseSupplierModal();
          _this.updatelist();
        });
      } else {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateSupplier, fieldsValue, { id: id }).then(function (repos) {
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.deleteSupplier, {}, { id: id }).then(function (repos) {
  ...
  (0, _createClass3.default)(Supplier, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { to: '/purchase/supplier/quotation/?id=' + record.id + '&uid=' + record.uid },
                '\u62A5\u4EF7'
              )
            );
          }
        ...
        upload_supplier_file: {
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/supplier/supplier_document/?id=' + record.id + '&uid=' + record.uid },
                '\u4E0A\u4F20'
              )
            );
          }
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _button2.default,
                {
                  ...
                  onClick: _this2.handleOpenSupplierModal
                },
                '\u7F16\u8F91'
              ),
    ...
    value: function render() {
      ...
      var supplierModal = _lodash2.default.get(mydata, 'supplierModal', {});
      return _react2.default.createElement(
        'div',
        { className: 'supplier' },
        _react2.default.createElement(
        ...
        supplierModal.visible && _react2.default.createElement(_SupplierModal2.default, (0, _extends3.default)({}, supplierModal, {
...
Supplier.propTypes = {
  ...
  changeSupplierModalAction: _propTypes2.default.func.isRequired
};
...
var SupplierModal = function (_React$Component) {
  (0, _inherits3.default)(SupplierModal, _React$Component);

  function SupplierModal(props) {
    (0, _classCallCheck3.default)(this, SupplierModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SupplierModal.__proto__ || (0, _getPrototypeOf2.default)(SupplierModal)).call(this, props));
  ...
  (0, _createClass3.default)(SupplierModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u4F9B\u5E94\u5546\u7F16\u53F7' }, formItemLayout),
                getFieldDecorator('uid', fieldsConfig['uid'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u4F9B\u5E94\u5546\u7F16\u53F7' }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u4F9B\u5E94\u5546\u540D\u79F0' }, formItemLayout),
                getFieldDecorator('name', fieldsConfig['name'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u9009\u62E9\u4F9B\u5E94\u5546\u540D\u79F0' }))
              )
            )
          )
        )
...
var SUPPLIER_GET_LIST_DATA = 'SUPPLIER_GET_LIST_DATA';
var SUPPLIER_ADD_LIST_DATA = 'SUPPLIER_ADD_LIST_DATA';
var SUPPLIER_CHANGE_SUPPLIER_MODAL = 'SUPPLIER_CHANGE_SUPPLIER_MODAL';
var PAGE_SIZE = 10;
...
function changeSupplierModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeSupplierModalAction: changeSupplierModalAction
...
function Supplier() {
  ...
  var map = {
    SUPPLIER_GET_LIST_DATA: function SUPPLIER_GET_LIST_DATA() {
    ...
    SUPPLIER_ADD_LIST_DATA: function SUPPLIER_ADD_LIST_DATA() {
    ...
    SUPPLIER_CHANGE_SUPPLIER_MODAL: function SUPPLIER_CHANGE_SUPPLIER_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(SUPPLIER_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getSuppliers, params);
