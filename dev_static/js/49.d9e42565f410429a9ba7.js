...
var _modules = __webpack_require__(955);

var _StatusBackTrack = __webpack_require__(1604);

var _StatusBackTrack2 = _interopRequireDefault(_StatusBackTrack);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_StatusBackTrack2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u6807\u5355\u5355\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _FilterBar = __webpack_require__(1603);
...
var columns = ['bidding_sheet_uid', 'bidding_sheet_status', 'history', 'change_status'];

var StatusBackTrack = function (_React$Component) {
  (0, _inherits3.default)(StatusBackTrack, _React$Component);

  function StatusBackTrack(props) {
    (0, _classCallCheck3.default)(this, StatusBackTrack);

    var _this = (0, _possibleConstructorReturn3.default)(this, (StatusBackTrack.__proto__ || (0, _getPrototypeOf2.default)(StatusBackTrack)).call(this, props));
  ...
  (0, _createClass3.default)(StatusBackTrack, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_StatusModal2.default, (0, _extends3.default)({}, modal, {
...
exports.default = StatusBackTrack;
...
var STATUSBACKTRACK_GET_LIST_DATA = 'STATUSBACKTRACK_GET_LIST_DATA';
var STATUSBACKTRACK_ADD_LIST_DATA = 'STATUSBACKTRACK_ADD_LIST_DATA';
var STATUSBACKTRACK_CHANGE_STATUS_MODAL = 'STATUSBACKTRACK_CHANGE_STATUS_MODAL';
var PAGE_SIZE = 10;
...
function StatusBackTrack() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    STATUSBACKTRACK_GET_LIST_DATA: function STATUSBACKTRACK_GET_LIST_DATA() {
    ...
    STATUSBACKTRACK_ADD_LIST_DATA: function STATUSBACKTRACK_ADD_LIST_DATA() {
    ...
    STATUSBACKTRACK_CHANGE_STATUS_MODAL: function STATUSBACKTRACK_CHANGE_STATUS_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(STATUSBACKTRACK_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getBiddingSheets, params);
