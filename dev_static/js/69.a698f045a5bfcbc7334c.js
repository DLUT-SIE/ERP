...
var _modules = __webpack_require__(942);

var _DetailTable = __webpack_require__(1564);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_DetailTable2.default));
...
var columns0 = ['spec_order', 'count_order', 'weight_order', 'total_weight', 'material_order', 'remark_order', 'action'];
var columns1 = ['spec_order', 'count_order', 'weight_order', 'total_weight', 'material_order', 'remark_order', 'action'];
var columns2 = ['name_order', 'drawing_number_order', 'ticket_number_order', 'count_order', 'material_order', 'weight_order', 'total_weight', 'remark_order', 'action'];
var columns3 = ['name_order', 'drawing_number_order', 'count_order', 'material_order', 'weight_order', 'total_weight', 'remark_order', 'action'];
var columns4 = ['name_order', 'spec_order', 'material_order', 'weight_order', 'total_weight', 'quota', 'remark_order', 'action'];
var columns5 = ['drawing_number_order', 'ticket_number_order', 'name_order', 'material_order', 'count_order', 'weight_order', 'total_weight', 'cooperation_content_order', 'action'];
var typeMap = {
  0: {
    title: '主材定额',
    columns: columns0
...
var DetailTable = function (_React$Component) {
  (0, _inherits3.default)(DetailTable, _React$Component);
  ...
  function DetailTable(props) {
    ...
    _this.handleAdd = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateProcurementMaterial, { status: 1 }, { id: id }).then(function (repos) {
    ...
    _this.handleAddAll = function () {
      ...
      _promise2.default.all(_lodash2.default.map(list, function (item) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateProcurementMaterial, { status: 1 }, { id: item.id });
      })).then(function () {
        console.log('success');
        _message4.default.success('全部添加成功！');
        _this.updatelist();
      });
    };
    ...
    _this._uid = query.sub_work_order_uid;
    _this._type = query.inventory_type;
  ...
  (0, _createClass3.default)(DetailTable, [{
    ...
    value: function componentDidMount() {
      ...
      this.fetchData(this._query(), function (data) {
        var columns = _this2.buildColumns(typeMap[_this2._type].columns);
      ...
      return _utils2.default.buildColumns(columns, {
        action: {
          render: function render(text, record, index) {
            return record.status === 0 ? _react2.default.createElement(
              _popconfirm2.default,
              {
                title: '\u786E\u5B9A\u52A0\u5165\u7269\u6599\u6C47\u603B\u5417\uFF1F',
                onConfirm: _this3.handleAdd(record.id),
                okText: '\u786E\u5B9A',
                cancelText: '\u53D6\u6D88'
              },
...
var DETAILTABLE_GET_LIST_DATA = 'DETAILTABLE_GET_LIST_DATA';
var DETAILTABLE_ADD_LIST_DATA = 'DETAILTABLE_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function DetailTable() {
  ...
  var map = {
    DETAILTABLE_GET_LIST_DATA: function DETAILTABLE_GET_LIST_DATA() {
    ...
    DETAILTABLE_ADD_LIST_DATA: function DETAILTABLE_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(DETAILTABLE_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getProcurementMaterials, params);
