...
var _modules = __webpack_require__(935);

var _WorkHourSearch = __webpack_require__(1549);

var _WorkHourSearch2 = _interopRequireDefault(_WorkHourSearch);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_WorkHourSearch2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('ticket_number')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5DE5\u4F5C\u7968\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('work_group')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u7EC4\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _FilterBar = __webpack_require__(1548);
...
var columns = ['sub_order_uid', 'ticket_number', 'work_group', 'step', 'man_hours', 'writer', 'quota_clerk', 'actual_finish_dt'];
// import fetchAPI from 'api'
// import { apis } from 'api/config'

var WorkHourSearch = function (_React$Component) {
  (0, _inherits3.default)(WorkHourSearch, _React$Component);

  function WorkHourSearch(props) {
    (0, _classCallCheck3.default)(this, WorkHourSearch);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WorkHourSearch.__proto__ || (0, _getPrototypeOf2.default)(WorkHourSearch)).call(this, props));
  ...
  (0, _createClass3.default)(WorkHourSearch, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        actual_finish_dt: {
          render: function render(text, record, index) {
            return record.actual_finish_dt && (0, _moment2.default)(record.actual_finish_dt).format('YYYY-MM-DD');
          }
        }
      });
    }
...
exports.default = WorkHourSearch;
...
var WORK_HOUR_SEARCH_GET_LIST_DATA = 'WORK_HOUR_SEARCH_GET_LIST_DATA';
var WORK_HOUR_SEARCH_ADD_LIST_DATA = 'WORK_HOUR_SEARCH_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function CompDepartment() {
  ...
  var map = {
    WORK_HOUR_SEARCH_GET_LIST_DATA: function WORK_HOUR_SEARCH_GET_LIST_DATA() {
    ...
    WORK_HOUR_SEARCH_ADD_LIST_DATA: function WORK_HOUR_SEARCH_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(WORK_HOUR_SEARCH_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProductionAPI.getManHourMessage, params);
