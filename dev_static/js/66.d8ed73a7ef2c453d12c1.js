...
var _modules = __webpack_require__(928);

var _AddProductionPlan = __webpack_require__(1528);

var _AddProductionPlan2 = _interopRequireDefault(_AddProductionPlan);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AddProductionPlan2.default));
...
var _FilterBar = __webpack_require__(1529);
...
var columns = ['work_order', 'client', 'delivery_dt', 'product', 'production_count', 'output_value', 'output', 'remarks', 'status_description'];

var AddProductionPlan = function (_React$Component) {
  (0, _inherits3.default)(AddProductionPlan, _React$Component);

  function AddProductionPlan(props) {
    (0, _classCallCheck3.default)(this, AddProductionPlan);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddProductionPlan.__proto__ || (0, _getPrototypeOf2.default)(AddProductionPlan)).call(this, props));
    ...
    _this.createProductionPlan = function (lists) {
      var values = {
        work_order_ids: lists
      };
      (0, _api2.default)(_config.apis.ProductionAPI.createProductionPlan, values).then(function (repos) {
    ...
    _this.handleAddRecords = function (fieldsValue) {
      ...
      _this.createProductionPlan(lists);
      console.log('addLists', _this.state.addLists);
    };
  ...
  (0, _createClass3.default)(AddProductionPlan, [{
    key: 'buildColumns',
...
exports.default = AddProductionPlan;
...
var FilterBar = function (_React$Component) {
  ...
  function FilterBar(props) {
    ...
    _this.handleAddProductionPlans = function (e) {
      e.preventDefault();
      var _this$props = _this.props,
...
var ADD_PRODUCTION_PLAN_GET_LIST_DATA = 'ADD_PRODUCTION_PLAN_GET_LIST_DATA';
var ADD_PRODUCTION_PLAN_ADD_LIST_DATA = 'ADD_PRODUCTION_PLAN_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function AddProductionPlan() {
  ...
  var map = {
    ADD_PRODUCTION_PLAN_GET_LIST_DATA: function ADD_PRODUCTION_PLAN_GET_LIST_DATA() {
    ...
    ADD_PRODUCTION_PLAN_ADD_LIST_DATA: function ADD_PRODUCTION_PLAN_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(ADD_PRODUCTION_PLAN_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProductionAPI.getNonProductionPlan, params);
