...
var _modules = __webpack_require__(914);

var _DetailedList = __webpack_require__(1487);

var _DetailedList2 = _interopRequireDefault(_DetailedList);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_DetailedList2.default));
...
var _EditModal = __webpack_require__(1488);
...
var columns1 = ['ticket_number', 'drawing_number', 'lib_name', 'count', 'material', 'weight_alias', 'process_routes', 'remark', 'action'];
var columns2 = ['ticket_number', 'drawing_number', 'lib_name', 'count', 'material', 'weight_alias', 'process_routes', 'collaborative_content', 'action'];
var typeMap = {
  'bought_in_items': {
    ...
    category: _const.DETAILED_TABLE_CATEGORY_MAP['外购件明细表'],
    columns: columns1
  },
  'first_feeding_items': {
    ...
    category: _const.DETAILED_TABLE_CATEGORY_MAP['先投件明细表'],
    columns: columns1
  },
  'cooperant_items': {
    ...
    category: _const.DETAILED_TABLE_CATEGORY_MAP['工序性外协明细表'],
    columns: columns2
  }
};

var DetailedList = function (_React$Component) {
  (0, _inherits3.default)(DetailedList, _React$Component);

  function DetailedList(props) {
    (0, _classCallCheck3.default)(this, DetailedList);

    var _this = (0, _possibleConstructorReturn3.default)(this, (DetailedList.__proto__ || (0, _getPrototypeOf2.default)(DetailedList)).call(this, props));

    _this.handleSave = function (id, fieldsValue) {
      (0, _api2.default)(_config.apis.ProcessAPI[_this._config.updateApi], fieldsValue, { id: id }).then(function (repos) {
        _message5.default.success('修改成功！');
        _this.handleCloseModal();
        _this.props.getListDataAction({
          api: _this._config.getApi,
          params: _this._query()
        });
      });
    };
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProcessAPI[_this._config.deleteApi], {}, { id: id }).then(function (repos) {
          _message5.default.success('删除成功！');
          _this.props.getListDataAction({
            api: _this._config.getApi,
            params: _this._query()
          });
    ...
    _this.state = {};
    _this._listType = _this.props.location.pathname.split('/')[2];
    _this._config = typeMap[_this._listType];
    _this._columns = _this.buildColumns();
    return _this;
  }

  (0, _createClass3.default)(DetailedList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function buildColumns() {
      ...
      return _utils2.default.buildColumns(this._config.columns, {
        weight_alias: {
          children: [{
            title: '单重',
        ...
        action: {
          render: function render(text, record, index) {
            var fieldsValue = _this2._listType === 'cooperant_items' ? {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _button2.default,
                {
                  ...
                  size: 'small',
                  'data-id': record.id,
                  'data-fields-value': (0, _stringify2.default)(fieldsValue),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_EditModal2.default, (0, _extends3.default)({
          type: this._listType,
  ...
  function EditModal(props) {
    ...
    _this.handleSave = function () {
      ...
      form.validateFields(function (err, values) {
        ...
        onOk && onOk(id, (0, _extends3.default)({}, values));
      });
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            form.getFieldDecorator('remark', fieldsConfig['remark'])(_react2.default.createElement(_input2.default, {
...
var DETAILEDLIST_GET_LIST_DATA = 'DETAILEDLIST_GET_LIST_DATA';
var DETAILEDLIST_ADD_LIST_DATA = 'DETAILEDLIST_ADD_LIST_DATA';
var DETAILEDLIST_GET_LIBRARY_DATA = 'DETAILEDLIST_GET_LIBRARY_DATA';
var DETAILEDLIST_ADD_LIBRARY_DATA = 'DETAILEDLIST_ADD_LIBRARY_DATA';
var DETAILEDLIST_RESET_DATA = 'DETAILEDLIST_RESET_DATA';
var DETAILEDLIST_CHANGE_MODAL_DATA = 'DETAILEDLIST_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function DetailedList() {
  ...
  var map = {
    DETAILEDLIST_GET_LIST_DATA: function DETAILEDLIST_GET_LIST_DATA() {
    ...
    DETAILEDLIST_ADD_LIST_DATA: function DETAILEDLIST_ADD_LIST_DATA() {
    ...
    DETAILEDLIST_ADD_LIBRARY_DATA: function DETAILEDLIST_ADD_LIBRARY_DATA() {
      var data = action.payload.data;
    ...
    DETAILEDLIST_RESET_DATA: function DETAILEDLIST_RESET_DATA() {
      return state.merge({
        workOrderInfo: {},
        list: []
      });
    },
    DETAILEDLIST_CHANGE_MODAL_DATA: function DETAILEDLIST_CHANGE_MODAL_DATA() {
...
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, _payload$params, params, api, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(DETAILEDLIST_GET_LIST_DATA);

        case 3:
          _ref = _context.sent;
          _ref$payload = _ref.payload;
          payload = _ref$payload === undefined ? {} : _ref$payload;
          callback = payload.callback, _payload$params = payload.params, params = _payload$params === undefined ? {} : _payload$params, api = payload.api;
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI[api], params);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(DETAILEDLIST_GET_LIBRARY_DATA);
