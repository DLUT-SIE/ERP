...
var _modules = __webpack_require__(920);

var _WeldingQuota = __webpack_require__(1506);

var _WeldingQuota2 = _interopRequireDefault(_WeldingQuota);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_WeldingQuota2.default));
...
var _WeldingQuotaModal = __webpack_require__(1507);

var _WeldingQuotaModal2 = _interopRequireDefault(_WeldingQuotaModal);

__webpack_require__(1679);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['category', 'material_name_welding', 'size', 'operative_norm', 'quota', 'remark', 'action'];

var WeldingQuota = function (_React$Component) {
  (0, _inherits3.default)(WeldingQuota, _React$Component);

  function WeldingQuota(props) {
    (0, _classCallCheck3.default)(this, WeldingQuota);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WeldingQuota.__proto__ || (0, _getPrototypeOf2.default)(WeldingQuota)).call(this, props));

    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProcessAPI.deleteWeldingQuota, {}, { id: id }).then(function (repos) {
    ...
    _this.handleOpenEditModal = function (e) {
      ...
      _this.fetchWeldingQuota(id, function (repos) {
    ...
    _this.handleChangeWeldingQuota = function (e) {
      ...
      _this.fetchWeldingQuota(list[index].id, function (repos) {
        changeModalAction({
          visible: true,
          index: index,
          fieldsValue: repos
    ...
    _this.handleSave = function (id, fieldsValue) {
      if (id) {
        (0, _api2.default)(_config.apis.ProcessAPI.updateWeldingQuota, fieldsValue, { id: id }).then(function (repos) {
      ...
      (0, _api2.default)(_config.apis.ProcessAPI.addWeldingQuota, (0, _extends3.default)({}, fieldsValue, {
    ...
    _this._category = _const.DETAILED_TABLE_CATEGORY_MAP['焊材明细表'];
    return _this;
  }

  (0, _createClass3.default)(WeldingQuota, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    key: 'fetchWeldingQuota',
    value: function fetchWeldingQuota(id, cb) {
      (0, _api2.default)(_config.apis.ProcessAPI.getWeldingQuota, {}, { id: id }).then(function (repos) {
        cb(repos);
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_WeldingQuotaModal2.default, (0, _extends3.default)({
...
var WeldingQuotaModal = function (_React$Component) {
  (0, _inherits3.default)(WeldingQuotaModal, _React$Component);

  function WeldingQuotaModal(props) {
    (0, _classCallCheck3.default)(this, WeldingQuotaModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WeldingQuotaModal.__proto__ || (0, _getPrototypeOf2.default)(WeldingQuotaModal)).call(this, props));
  ...
  (0, _createClass3.default)(WeldingQuotaModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u7C7B\u522B' }, formItemLayout),
                getFieldDecorator('category', fieldsConfig['category'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u7C7B\u522B', disabled: true }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u724C\u53F7' }, formItemLayout),
...
var WELDING_GET_LIST_DATA = 'WELDING_GET_LIST_DATA';
var WELDING_ADD_LIST_DATA = 'WELDING_ADD_LIST_DATA';
var WELDING_GET_LIBRARY_DATA = 'WELDING_GET_LIBRARY_DATA';
var WELDING_ADD_LIBRARY_DATA = 'WELDING_ADD_LIBRARY_DATA';
var WELDING_GET_MATERIALS_DATA = 'WELDING_GET_MATERIALS_DATA';
var WELDING_ADD_MATERIALS_DATA = 'WELDING_ADD_MATERIALS_DATA';
var WELDING_RESET_DATA = 'WELDING_RESET_DATA';
var WELDING_CHANGE_MODAL = 'WELDING_CHANGE_MODAL';
var PAGE_SIZE = 10;
...
function WeldingQuota() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    WELDING_GET_LIST_DATA: function WELDING_GET_LIST_DATA() {
    ...
    WELDING_ADD_LIST_DATA: function WELDING_ADD_LIST_DATA() {
    ...
    WELDING_ADD_LIBRARY_DATA: function WELDING_ADD_LIBRARY_DATA() {
      var data = action.payload.data;
    ...
    WELDING_ADD_MATERIALS_DATA: function WELDING_ADD_MATERIALS_DATA() {
      var data = action.payload.data;
    ...
    WELDING_RESET_DATA: function WELDING_RESET_DATA() {
      return state.merge({
        workOrderInfo: {},
        list: []
      });
    },
    WELDING_CHANGE_MODAL: function WELDING_CHANGE_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(WELDING_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getWeldingQuotas, params);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(WELDING_GET_LIBRARY_DATA);
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _effects.take)(WELDING_GET_MATERIALS_DATA);
        ...
        case 3:
          ...
          _context3.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getTotalWeldingMaterials, _params2);
