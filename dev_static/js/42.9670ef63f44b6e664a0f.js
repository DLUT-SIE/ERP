...
var FilterBar = function (_React$Component) {
  ...
  (0, _createClass3.default)(FilterBar, [{
    ...
    value: function render() {
      ...
      console.log(_index.MATERIAL_CATEGORY);
      return _react2.default.createElement(
        _form2.default,
        {
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('name')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5E93\u623F\u540D\u79F0' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('location')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u4F4D\u7F6E' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('category')(_react2.default.createElement(_CustomSelect2.default, {
            placeholder: '\u8BF7\u9009\u62E9\u6750\u6599\u7C7B\u578B',
            list: _index.MATERIAL_CATEGORY
          }))
        ),
        _react2.default.createElement(
          FormItem,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _button2.default,
            { type: 'success', icon: 'plus', onClick: this.props.onAddClick },
            '\u65B0\u589E\u5E93\u623F'
          )
        )
      );
...
var makeFields = function makeFields(fieldsValue) {
  ...
  _lodash2.default.forEach(fieldsValue, function (value, key) {
    result[key] = _form2.default.createFormField({ value: value });
    if (key === 'category') {
      result[key] = _form2.default.createFormField({ value: 0 });
    }
  });
  return result;
};
...
var _FilterBar = __webpack_require__(1437);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _WarehouseModal = __webpack_require__(1439);

var _WarehouseModal2 = _interopRequireDefault(_WarehouseModal);
...
var columns = ['warehouse_name', 'location', 'pretty_category', 'action'];

var WarehouseManage = function (_React$Component) {
  (0, _inherits3.default)(WarehouseManage, _React$Component);

  function WarehouseManage(props) {
    (0, _classCallCheck3.default)(this, WarehouseManage);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WarehouseManage.__proto__ || (0, _getPrototypeOf2.default)(WarehouseManage)).call(this, props));
    ...
    _this.handleOpenEditModal = function (e) {
      ...
      (0, _api2.default)(_config.apis.InventoryAPI.getWarehouseRecordsDetail, null, { id: id }).then(function (resp) {
    ...
    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.InventoryAPI.deleteWarehouseRecord, { id: id }).then(function (repos) {
    ...
    _this.handleAddRecords = function (e) {
      _this.props.changeModalAction({
        visible: true,
        fieldsValue: {}
      });
    ...
    _this.handleSave = function (fieldsValue) {
      if (fieldsValue.id) {
        (0, _api2.default)(_config.apis.InventoryAPI.updateWarehouseRecord, fieldsValue, { id: fieldsValue.id }).then(function (repos) {
      ...
      (0, _api2.default)(_config.apis.InventoryAPI.createWarehouseRecord, fieldsValue).then(function (repos) {
        _this.handleCloseModal();
        _message5.default.success('新建成功！');
        _this.props.getListDataAction({
          params: _this._query()
        });
      });
  ...
  (0, _createClass3.default)(WarehouseManage, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_WarehouseModal2.default, (0, _extends3.default)({
...
exports.default = WarehouseManage;
...
var WarehouseModal = function (_React$Component) {
  (0, _inherits3.default)(WarehouseModal, _React$Component);

  function WarehouseModal(props) {
    (0, _classCallCheck3.default)(this, WarehouseModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WarehouseModal.__proto__ || (0, _getPrototypeOf2.default)(WarehouseModal)).call(this, props));
    ...
    _this.handleSave = function () {
      ...
      form.validateFields(function (err, values) {
        ...
        if (_lodash2.default.isUndefined(values.remark)) {
          values.remark = '';
        }
  ...
  (0, _createClass3.default)(WarehouseModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      var id = fieldsValue && fieldsValue.id;
      return _react2.default.createElement(
        _form2.default,
        null,
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5E93\u623F\u540D\u79F0' }, formItemLayout),
            getFieldDecorator('name', fieldsConfig['name'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u5E93\u623F\u540D\u79F0' }))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u4F4D\u7F6E' }, formItemLayout),
            getFieldDecorator('location', fieldsConfig['location'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u4F4D\u7F6E' }))
          ),
          _react2.default.createElement(
            FormItem,
...
var WAREHOUSE_GET_LIST_DATA = 'WAREHOUSE_GET_LIST_DATA';
var WAREHOUSE_ADD_LIST_DATA = 'WAREHOUSE_ADD_LIST_DATA';
var WAREHOUSE_CHANGE_MODAL_DATA = 'WAREHOUSE_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function WareHouse() {
  ...
  var map = {
    WAREHOUSE_GET_LIST_DATA: function WAREHOUSE_GET_LIST_DATA() {
    ...
    WAREHOUSE_ADD_LIST_DATA: function WAREHOUSE_ADD_LIST_DATA() {
    ...
    WAREHOUSE_CHANGE_MODAL_DATA: function WAREHOUSE_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(WAREHOUSE_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.InventoryAPI.getWarehouseRecords, params);
...
var _modules = __webpack_require__(892);

var _WarehouseManage = __webpack_require__(1438);

var _WarehouseManage2 = _interopRequireDefault(_WarehouseManage);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_WarehouseManage2.default));
