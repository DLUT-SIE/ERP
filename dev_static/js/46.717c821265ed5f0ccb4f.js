...
var _modules = __webpack_require__(953);

var _PurchaseTrack = __webpack_require__(1600);

var _PurchaseTrack2 = _interopRequireDefault(_PurchaseTrack);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PurchaseTrack2.default));
...
var StatusModal = function (_React$Component) {
  (0, _inherits3.default)(StatusModal, _React$Component);

  function StatusModal(props) {
    (0, _classCallCheck3.default)(this, StatusModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (StatusModal.__proto__ || (0, _getPrototypeOf2.default)(StatusModal)).call(this, props));
  ...
  (0, _createClass3.default)(StatusModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u65B0\u72B6\u6001' }, formItemLayout),
                getFieldDecorator('new_status', fieldsConfig['new_status'])(_react2.default.createElement(_CustomSelect2.default, {
                  placeholder: '\u8BF7\u9009\u62E9\u65B0\u72B6\u6001',
                  list: _const.BIDDING_SHEET_STATUS_LIST
                }))
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u6807\u5355\u7F16\u53F7' }, formItemLayout),
                getFieldDecorator('bidding_sheet', fieldsConfig['bidding_sheet'])(_react2.default.createElement(_input2.default, { disabled: true }))
              )
            ),
            _react2.default.createElement(
              _col2.default,
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u5F53\u524D\u72B6\u6001' }, formItemLayout),
                getFieldDecorator('pretty_original_status', fieldsConfig['pretty_original_status'])(_react2.default.createElement(_input2.default, { disabled: true }))
              )
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u56DE\u6EAF\u539F\u56E0' }, formItemLayoutReason),
                getFieldDecorator('reason', fieldsConfig['reason'])(_react2.default.createElement(TextArea, { placeholder: '\u8BF7\u8F93\u5165\u56DE\u6EAF\u539F\u56E0', rows: 4 }))
              )
            )
          )
        )
...
var _StatusModal = __webpack_require__(1407);

var _StatusModal2 = _interopRequireDefault(_StatusModal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _StatusModal2.default;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6807\u5355\u7F16\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _FilterBar = __webpack_require__(1599);
...
var _StatusModal = __webpack_require__(1408);
...
var columns = ['bidding_sheet_uid', 'supplier_select', 'call_for_bid', 'process_track', 'checkout_entry', 'bid_pretty_status', 'status_change_history', 'status_backtrack'];

var PurchaseTrack = function (_React$Component) {
  (0, _inherits3.default)(PurchaseTrack, _React$Component);

  function PurchaseTrack(props) {
    (0, _classCallCheck3.default)(this, PurchaseTrack);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PurchaseTrack.__proto__ || (0, _getPrototypeOf2.default)(PurchaseTrack)).call(this, props));

    _this.getBtnType = function (status, currentStatus) {
      var btnType = void 0;
    ...
    _this.handleCloseStatusModal = function () {
      _this.props.changeStatusModalAction({
        visible: false
      });
    };

    _this.handleSaveStatusChange = function (fieldsValue) {
      (0, _api2.default)(_config.apis.PurchaseAPI.addStatusChanges, fieldsValue).then(function (repos) {
        _message3.default.success('更改成功！');
        _this.handleCloseStatusModal();
        _this.updatelist();
      });
    };
  ...
  (0, _createClass3.default)(PurchaseTrack, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        supplier_select: {
          render: function render(text, record, index) {
            var status = _const.BID_STATUS_MAP['供应商选择'];
            var btnType = _this2.getBtnType(status, record.status);
            return _react2.default.createElement(
              _button2.default,
              {
                type: btnType,
              ...
              record.status === status ? _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/purchase_track/supplier_select/?id=' + record.id },
                '\u4F9B\u5E94\u5546\u9009\u62E9'
              ) : '供应商选择'
            );
          }
        ...
        call_for_bid: {
          render: function render(text, record, index) {
            var btnType = void 0;
            var statusStart = _const.BID_STATUS_MAP['招标申请选择'];
            var statusEnd = _const.BID_STATUS_MAP['中标确认'];
            ...
            return _react2.default.createElement(
              ...
              btnType === 'primary' ? _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/purchase_track/call_for_bid/?id=' + record.id },
                '\u62DB\u6807'
              ) : '招标'
            );
          }
        ...
        process_track: {
          render: function render(text, record, index) {
            var status = _const.BID_STATUS_MAP['进程跟踪'];
            var btnType = _this2.getBtnType(status, record.status);
            return _react2.default.createElement(
              _button2.default,
              {
              ...
              record.status === status ? _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/purchase_track/process_track/?id=' + record.id },
                '\u8FDB\u7A0B\u8DDF\u8E2A'
              ) : '进程跟踪'
            );
          }
        ...
        checkout_entry: {
          render: function render(text, record, index) {
            var btnType = void 0;
            var statusStart = _const.BID_STATUS_MAP['标单检验'];
            var statusEnd = _const.BID_STATUS_MAP['标单入库'];
            if (record.status > statusEnd) {
              btnType = 'success';
            } else if (record.status < statusStart) {
              btnType = 'default';
            ...
            return _react2.default.createElement(
              ...
              btnType === 'primary' ? _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/purchase_track/checkout_entry/?id=' + record.id + '&status=' + record.status },
                '\u68C0\u9A8C\u5165\u5E93'
              ) : '检验入库'
            );
          }
        ...
        status_change_history: {
          render: function render(text, record, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouterDom.Link,
                { to: '/purchase/status_back_track/status_history/?uid=' + record.uid + '&id=' + record.id },
                '\u67E5\u770B'
              )
            );
          }
          ...
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                onClick: _this2.handleOpenStatusModal
              },
              '\u66F4\u6539\u72B6\u6001'
            );
          }
    ...
    value: function render() {
      ...
      var statusModal = _lodash2.default.get(mydata, 'statusModal', {});
      return _react2.default.createElement(
        'div',
        { className: 'purchase-track' },
        ...
        statusModal.visible && _react2.default.createElement(_StatusModal2.default, (0, _extends3.default)({}, statusModal, {
...
PurchaseTrack.propTypes = {
  ...
  changeStatusModalAction: _propTypes2.default.func.isRequired
};

exports.default = PurchaseTrack;
...
var TRACK_GET_LIST_DATA = 'TRACK_GET_LIST_DATA';
var TRACK_ADD_LIST_DATA = 'TRACK_ADD_LIST_DATA';
var TRACK_CHANGE_STATUS_MODAL = 'TRACK_CHANGE_STATUS_MODAL';
var PAGE_SIZE = 10;
...
function changeStatusModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeStatusModalAction: changeStatusModalAction
...
function PurchaseTrack() {
  ...
  var map = {
    TRACK_GET_LIST_DATA: function TRACK_GET_LIST_DATA() {
    ...
    TRACK_ADD_LIST_DATA: function TRACK_ADD_LIST_DATA() {
    ...
    TRACK_CHANGE_STATUS_MODAL: function TRACK_CHANGE_STATUS_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(TRACK_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getBiddingSheetsWithStatus, params);
