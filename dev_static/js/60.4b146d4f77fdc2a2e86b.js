...
var _modules = __webpack_require__(926);

var _AddRefundCard = __webpack_require__(1523);

var _AddRefundCard2 = _interopRequireDefault(_AddRefundCard);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AddRefundCard2.default));
...
var _FilterBar = __webpack_require__(1524);
...
var columns = ['radio', 'common_uid', 'common_material_mark', 'specification', 'refund_count', 'action'];
var mapRequest = {
  welding_material_refund_cards: _config.apis.ProductionAPI.createWeldingMaterialRefundCards,
  steel_material_refund_cards: _config.apis.ProductionAPI.createSteelMaterialRefundCards,
  bought_in_component_refund_cards: _config.apis.ProductionAPI.createBroughtInMaterialRefundCards
};

var AddRefundCard = function (_React$Component) {
  (0, _inherits3.default)(AddRefundCard, _React$Component);

  function AddRefundCard(props) {
    (0, _classCallCheck3.default)(this, AddRefundCard);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddRefundCard.__proto__ || (0, _getPrototypeOf2.default)(AddRefundCard)).call(this, props));

    _this.handleAddRefunds = function (e) {
      var _e$target$dataset = e.target.dataset,
          id = _e$target$dataset.id,
          count = _e$target$dataset.count;
      ...
      (0, _api2.default)(mapRequest[category], values);
    };

    _this.handleSearch = function (searchValue) {
      if (!_lodash2.default.isUndefined(searchValue.category)) {
        _this.setState({ category: searchValue.category });
      }
    ...
    _this.handleRefundTypeChange = function (value) {
      _this.setState({ category: value });
    };
  ...
  (0, _createClass3.default)(AddRefundCard, [{
    key: 'componentDidMount',
    value: function componentDidMount() {}
  }, {
    key: 'buildColumns',
      ...
      return _utils2.default.buildColumns(columns, {
        radio: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_radio2.default, { value: record.id, checked: true });
          }
        },
        action: {
          render: function render(text, record, index) {
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                onClick: _this2.handleAddRefunds },
              '\u6DFB\u52A0'
            );
          }
        }
...
var FilterBar = function (_React$Component) {
  ...
  function FilterBar(props) {
    ...
    _this.onSelectChange = function (value) {
      var onRefundTypeChange = _this.props.onRefundTypeChange;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u9886\u7528\u5361\u7F16\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('category', {
            ...
            rules: [{ required: true, message: '请选择材料类型' }] })(_react2.default.createElement(_CustomSelect2.default, { list: _const.MATERIAL_REFUND_CARD, placeholder: '\u8BF7\u9009\u62E9\u6750\u6599\u7C7B\u578B', onChange: this.onSelectChange }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
FilterBar.propTypes = {
  ...
  onRefundTypeChange: _propTypes2.default.func.isRequired
};
...
exports.default = AddRefundCardUser;
...
var ADD_REFUND_CARD_GET_LIST_DATA = 'ADD_REFUND_CARD_GET_LIST_DATA';
var ADD_REFUND_CARD_ADD_LIST_DATA = 'ADD_REFUND_CARD_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function AddRefundCardUser() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    ADD_REFUND_CARD_GET_LIST_DATA: function ADD_REFUND_CARD_GET_LIST_DATA() {
    ...
    ADD_REFUND_CARD_ADD_LIST_DATA: function ADD_REFUND_CARD_ADD_LIST_DATA() {
...
// ------------------------------------
var mapRequest = {
  welding_material_refund_cards: _config.apis.ProductionAPI.getWeldingMaterialCompletedApplyCards,
  steel_material_refund_cards: _config.apis.ProductionAPI.getSteelMaterialCompletedApplyCards,
  bought_in_component_refund_cards: _config.apis.ProductionAPI.getBroughtInMaterialCompletedApplyCards
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(ADD_REFUND_CARD_GET_LIST_DATA);
        ...
        case 3:
          ...
          if (_lodash2.default.isUndefined(category)) {
            category = _config.apis.ProductionAPI.getWeldingMaterialCompletedApplyCards;
          }
          _context.next = 11;
