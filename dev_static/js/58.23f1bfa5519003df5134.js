...
var _modules = __webpack_require__(949);

var _PendingOrder = __webpack_require__(1588);

var _PendingOrder2 = _interopRequireDefault(_PendingOrder);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PendingOrder2.default));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('work_order_uid')(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6240\u5C5E\u5DE5\u4F5C\u4EE4\u7F16\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var _FilterBar = __webpack_require__(1587);
...
var columns = ['sub_work_order_uid', 'detail', 'action'];

var PendingOrder = function (_React$Component) {
  (0, _inherits3.default)(PendingOrder, _React$Component);

  function PendingOrder(props) {
    (0, _classCallCheck3.default)(this, PendingOrder);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PendingOrder.__proto__ || (0, _getPrototypeOf2.default)(PendingOrder)).call(this, props));
    ...
    _this.handleFinished = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.PurchaseAPI.updateSubWorkOrder, { finished: true }, { id: id }).then(function (repos) {
    ...
    _this.handleCheck = function (e) {
      var _e$target$dataset = e.target.dataset,
          uid = _e$target$dataset.uid,
          index = _e$target$dataset.index;
      var typeList = _this.state.typeList;

      var type = typeList[index];
      if (type === -1) {
        _message4.default.warning('请先选择要查看的明细表类别！');
        return;
      }
  ...
  (0, _createClass3.default)(PendingOrder, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      this.fetchData(this._query(), function (repos) {
        var typeList = _lodash2.default.map(repos.results, function (item) {
          return -1;
        });
        _this2.setState({
          typeList: typeList
        }, function () {
          var columns = _this2.buildColumns();
          _this2.props.addListDataAction({ data: repos, columns: columns });
        });
      });
    }
  }, {
...
var PENDING_GET_LIST_DATA = 'PENDING_GET_LIST_DATA';
var PENDING_ADD_LIST_DATA = 'PENDING_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function PendingOrder() {
  ...
  var map = {
    PENDING_GET_LIST_DATA: function PENDING_GET_LIST_DATA() {
    ...
    PENDING_ADD_LIST_DATA: function PENDING_ADD_LIST_DATA() {
      ...
      return state.mergeIn(['pagination'], { total: data.count }).merge(params);
    }
  };
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PENDING_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getSubWorkOrders, params);
