...
var _modules = __webpack_require__(913);

var _AuxiliaryQuota = __webpack_require__(1485);

var _AuxiliaryQuota2 = _interopRequireDefault(_AuxiliaryQuota);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AuxiliaryQuota2.default));
...
var AddBar = function (_React$Component) {
  (0, _inherits3.default)(AddBar, _React$Component);

  function AddBar(props) {
    (0, _classCallCheck3.default)(this, AddBar);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddBar.__proto__ || (0, _getPrototypeOf2.default)(AddBar)).call(this, props));
    ...
    _this.handleSubmit = function (e) {
      ...
      form.validateFields(function () {
        var fieldsValue = form.getFieldsValue();
        onAdd && onAdd((0, _extends3.default)({}, fieldsValue));
      });
    };
  ...
  (0, _createClass3.default)(AddBar, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          { label: '\u7968\u53F7' },
          form.getFieldDecorator('ticket_number', {})(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u7968\u53F7' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var WrappedForm = _form2.default.create()(AddBar);
...
var _AddBar = __webpack_require__(1405);

var _AddBar2 = _interopRequireDefault(_AddBar);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _AddBar2.default;
...
var _AddBar = __webpack_require__(1406);
...
var _AuxiliaryQuotaModal = __webpack_require__(1486);

var _AuxiliaryQuotaModal2 = _interopRequireDefault(_AuxiliaryQuotaModal);

__webpack_require__(1666);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['ticket_number', 'unit_drawing_number', 'part_drawing_number', 'category', 'material', 'spec', 'count', 'piece_weight', 'gross_weight', 'quota', 'use_ratio', 'press_mark', 'action'];

var AuxiliaryQuota = function (_React$Component) {
  (0, _inherits3.default)(AuxiliaryQuota, _React$Component);

  function AuxiliaryQuota(props) {
    (0, _classCallCheck3.default)(this, AuxiliaryQuota);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AuxiliaryQuota.__proto__ || (0, _getPrototypeOf2.default)(AuxiliaryQuota)).call(this, props));

    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProcessAPI.deleteAuxiliaryQuota, {}, { id: id }).then(function (repos) {
    ...
    _this.handleOpenModal = function (e) {
      ...
      _this.fetchAuxiliaryQuota(id, function (repos) {
    ...
    _this.handleChangeAuxiliaryQuota = function (e) {
      ...
      _this.fetchAuxiliaryQuota(list[index].id, function (repos) {
        changeModalAction({
          visible: true,
          index: +index,
          fieldsValue: repos
    ...
    _this.handleAdd = function (fieldsValue) {
      var mydata = _this.props.status.toJS();
      var workOrderInfo = _lodash2.default.get(mydata, 'workOrderInfo', {});
      (0, _api2.default)(_config.apis.ProcessAPI.addAuxiliaryQuota, {
    ...
    _this.handleSave = function (id, fieldsValue) {
      (0, _api2.default)(_config.apis.ProcessAPI.updateAuxiliaryQuota, fieldsValue, { id: id }).then(function (repos) {
    ...
    _this._category = _const.DETAILED_TABLE_CATEGORY_MAP['辅材定额明细表'];
    return _this;
  }

  (0, _createClass3.default)(AuxiliaryQuota, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    key: 'fetchAuxiliaryQuota',
    value: function fetchAuxiliaryQuota(id, cb) {
      (0, _api2.default)(_config.apis.ProcessAPI.getAuxiliaryQuota, {}, { id: id }).then(function (repos) {
        cb(repos);
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'auxiliary-quota' },
        _react2.default.createElement(_WorkOrderFilterBar2.default, {
          className: 'filterbar',
          fieldsValue: query,
          onSearch: this.handleSearch
        }),
        workOrderInfo.id && _react2.default.createElement(_AddBar2.default, {
        ...
        modal.visible && _react2.default.createElement(_AuxiliaryQuotaModal2.default, (0, _extends3.default)({
...
exports.default = AuxiliaryQuota;
...
var AuxiliaryQuotaModal = function (_React$Component) {
  (0, _inherits3.default)(AuxiliaryQuotaModal, _React$Component);

  function AuxiliaryQuotaModal(props) {
    (0, _classCallCheck3.default)(this, AuxiliaryQuotaModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AuxiliaryQuotaModal.__proto__ || (0, _getPrototypeOf2.default)(AuxiliaryQuotaModal)).call(this, props));
    ...
    _this.handleSave = function () {
      ...
      form.validateFields(function (err, values) {
        ...
        onOk && onOk(fieldsValue.id, (0, _extends3.default)({}, values));
      });
    };
  ...
  (0, _createClass3.default)(AuxiliaryQuotaModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _col2.default,
                { span: 3, className: 'original-data-label' },
                '\u5DE5\u4F5C\u7968\u53F7\uFF1A'
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 5, className: 'original-data-value' },
                fieldsValue.ticket_number
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 3, className: 'ant-form-item-label' },
                '\u90E8\u4EF6\u56FE\u53F7\uFF1A'
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 5, className: 'original-data-value' },
                fieldsValue.unit_drawing_number
              ),
              _react2.default.createElement(
                _col2.default,
                { span: 3, className: 'ant-form-item-label' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  FormItem,
                  (0, _extends3.default)({ label: '\u5B9A\u989D\u7CFB\u6570' }, formItemLayout),
                  getFieldDecorator('quota_coef', fieldsConfig['quota_coef'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u5B9A\u989D\u7CFB\u6570' }))
                )
              ),
              _react2.default.createElement(
                _col2.default,
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  FormItem,
                  (0, _extends3.default)({ label: '\u6807\u51C6\u4EE3\u7801' }, formItemLayout),
                  getFieldDecorator('stardard_code', fieldsConfig['stardard_code'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6807\u51C6\u4EE3\u7801' }))
                )
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  FormItem,
                  (0, _extends3.default)({ label: '\u6750\u6599\u79CD\u7C7B' }, formItemLayout),
                  getFieldDecorator('category', fieldsConfig['category'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6750\u6599\u79CD\u7C7B' }))
                )
              ),
              _react2.default.createElement(
                _col2.default,
...
var AUXILIARY_GET_LIST_DATA = 'AUXILIARY_GET_LIST_DATA';
var AUXILIARY_ADD_LIST_DATA = 'AUXILIARY_ADD_LIST_DATA';
var AUXILIARY_GET_LIBRARY_DATA = 'AUXILIARY_GET_LIBRARY_DATA';
var AUXILIARY_ADD_LIBRARY_DATA = 'AUXILIARY_ADD_LIBRARY_DATA';
var AUXILIARY_RESET_DATA = 'AUXILIARY_RESET_DATA';
var AUXILIARY_CHANGE_MODAL_DATA = 'AUXILIARY_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function AuxiliaryQuota() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    AUXILIARY_GET_LIST_DATA: function AUXILIARY_GET_LIST_DATA() {
    ...
    AUXILIARY_ADD_LIST_DATA: function AUXILIARY_ADD_LIST_DATA() {
    ...
    AUXILIARY_ADD_LIBRARY_DATA: function AUXILIARY_ADD_LIBRARY_DATA() {
      var data = action.payload.data;
    ...
    AUXILIARY_RESET_DATA: function AUXILIARY_RESET_DATA() {
      return state.merge({
        workOrderInfo: {},
        list: []
      });
    },
    AUXILIARY_CHANGE_MODAL_DATA: function AUXILIARY_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(AUXILIARY_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getAuxiliaryQuotas, params);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(AUXILIARY_GET_LIBRARY_DATA);
...
var sagas = exports.sagas = [getListSaga, getLibrarySaga];
