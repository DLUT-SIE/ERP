...
var _modules = __webpack_require__(940);

var _Contract = __webpack_require__(1562);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Contract2.default));
...
var fieldsConfig = function fieldsConfig(prepaidAmounts) {
  return {
    amount: {
      rules: [{
...
var AmountModal = function (_React$Component) {
  (0, _inherits3.default)(AmountModal, _React$Component);

  function AmountModal(props) {
    (0, _classCallCheck3.default)(this, AmountModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AmountModal.__proto__ || (0, _getPrototypeOf2.default)(AmountModal)).call(this, props));
  ...
  (0, _createClass3.default)(AmountModal, [{
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                FormItem,
                (0, _extends3.default)({ label: '\u91D1\u989D' }, formItemLayout),
                getFieldDecorator('amount', this._fieldsConfig['amount'])(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u91D1\u989D' }))
              )
            )
          )
        )
...
AmountModal.propTypes = {
  ...
  prepaidAmounts: _propTypes2.default.number.isRequired,
...
var _AmountModal = __webpack_require__(1561);

var _AmountModal2 = _interopRequireDefault(_AmountModal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['contract_number', 'accept_supplier', 'content', 'contract_amount', 'billing_amount', 'payable_amounts', 'prepaid_amounts', 'action'];

var Contract = function (_React$Component) {
  (0, _inherits3.default)(Contract, _React$Component);

  function Contract(props) {
    (0, _classCallCheck3.default)(this, Contract);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Contract.__proto__ || (0, _getPrototypeOf2.default)(Contract)).call(this, props));
    ...
    _this.handleOpenAmountModal = function (e) {
      var _e$target$dataset = e.target.dataset,
          id = _e$target$dataset.id,
          prepaidAmounts = _e$target$dataset.prepaidAmounts;

      console.log('handleOpenAmountModal', e.target.dataset);
      _this.props.changeAmountModalAction({
        visible: true,
        id: +id,
    ...
    _this.handleCloseAmountModal = function () {
      _this.props.changeAmountModalAction({
        visible: false
      });
    };

    _this.handleSaveAmount = function (id, fieldsValue) {
      (0, _api2.default)(_config.apis.PurchaseAPI.addContractDetail, (0, _extends3.default)({}, fieldsValue, {
        bidding_sheet: id
      })).then(function (repos) {
        _message3.default.success('添加成功！');
        _this.handleCloseAmountModal();
        _this.updatelist();
      });
    };
  ...
  (0, _createClass3.default)(Contract, [{
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _button2.default,
                {
                  ...
                  onClick: _this2.handleOpenAmountModal
                },
                '\u6DFB\u52A0\u5DF2\u4ED8\u91D1\u989D'
              ),
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { to: '/purchase/contract/contract_detail/?id=' + record.id },
                  '\u67E5\u770B\u5DF2\u4ED8\u91D1\u989D\u660E\u7EC6'
                )
              )
            );
    ...
    value: function render() {
      ...
      var amountModal = _lodash2.default.get(mydata, 'amountModal', {});
      return _react2.default.createElement(
        'div',
        { className: 'contract' },
        ...
        amountModal.visible && _react2.default.createElement(_AmountModal2.default, (0, _extends3.default)({}, amountModal, {
...
Contract.propTypes = {
  ...
  changeAmountModalAction: _propTypes2.default.func.isRequired
};
...
var CONTRACT_GET_LIST_DATA = 'CONTRACT_GET_LIST_DATA';
var CONTRACT_ADD_LIST_DATA = 'CONTRACT_ADD_LIST_DATA';
var CONTRACT_CHANGE_AMOUNT_MODAL = 'CONTRACT_CHANGE_AMOUNT_MODAL';
var PAGE_SIZE = 10;
...
function changeAmountModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  ...
  changeAmountModalAction: changeAmountModalAction
...
function Contract() {
  ...
  var map = {
    CONTRACT_GET_LIST_DATA: function CONTRACT_GET_LIST_DATA() {
    ...
    CONTRACT_ADD_LIST_DATA: function CONTRACT_ADD_LIST_DATA() {
    ...
    CONTRACT_CHANGE_AMOUNT_MODAL: function CONTRACT_CHANGE_AMOUNT_MODAL() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(CONTRACT_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.PurchaseAPI.getContracts, params);
