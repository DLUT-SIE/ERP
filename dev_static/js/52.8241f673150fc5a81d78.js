...
var _modules = __webpack_require__(932);

var _TaskAllocation = __webpack_require__(1539);

var _TaskAllocation2 = _interopRequireDefault(_TaskAllocation);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TaskAllocation2.default));
...
var _FilterBar = __webpack_require__(1538);

var _FilterBar2 = _interopRequireDefault(_FilterBar);

var _TaskAllocationModal = __webpack_require__(1540);

var _TaskAllocationModal2 = _interopRequireDefault(_TaskAllocationModal);
...
var ProductionPlan = function (_React$Component) {
  ...
  function ProductionPlan(props) {
    ...
    _this.fetchGroupInfo = function (processName, cb) {
      var _apis$ProductionAPI$g = _config.apis.ProductionAPI.getProductionWorkGroup,
          url = _apis$ProductionAPI$g.url,
          method = _apis$ProductionAPI$g.method;

      var param = '?process_name=' + processName;
      url = url + param;
      var api = {
        url: url,
        method: method
      ...
      console.log(api);
      (0, _api2.default)(api).then(function (repos) {
        cb(repos.results);
      });
    };
    ...
    _this.handleOpenEditModal = function (e) {
      var _e$target$dataset = e.target.dataset,
          fieldsValue = _e$target$dataset.fieldsValue,
          index = _e$target$dataset.index,
          name = _e$target$dataset.name;

      _this.fetchGroupInfo(name, function (repos) {
    ...
    _this.handleRedo = function (e) {
      var id = e.target.dataset.id;

      var values = {};
      values.status = _const.PROCESS_DETAIL_STATUS.PLANED;
      console.log(values);
      (0, _api2.default)(_config.apis.ProductionAPI.updateProcessDetails, values, { id: id }).then(function (repos) {
    ...
    _this.handleSave = function (fieldsValue) {
      fieldsValue.status = _const.PROCESS_DETAIL_STATUS.ALLOCATION;
  ...
  (0, _createClass3.default)(ProductionPlan, [{
      ...
      return _utils2.default.buildColumns(columns, {
        ...
        action: {
          render: function render(text, record, index) {
            ...
            if (record.status === _const.PROCESS_DETAIL_STATUS.ALLOCATION) {
              return _react2.default.createElement(
                _button2.default,
                {
                  type: 'danger',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        modal.visible && _react2.default.createElement(_TaskAllocationModal2.default, (0, _extends3.default)({
...
var TaskAllocationModal = function (_React$Component) {
  (0, _inherits3.default)(TaskAllocationModal, _React$Component);

  function TaskAllocationModal(props) {
    (0, _classCallCheck3.default)(this, TaskAllocationModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (TaskAllocationModal.__proto__ || (0, _getPrototypeOf2.default)(TaskAllocationModal)).call(this, props));
  ...
  (0, _createClass3.default)(TaskAllocationModal, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5DE5\u4F5C\u7968\u53F7' }, formItemLayout),
            getFieldDecorator('material_index')(_react2.default.createElement(_input2.default, { disabled: true }))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5DE5\u4F5C\u4EE4' }, formItemLayout),
            getFieldDecorator('work_order_uid')(_react2.default.createElement(_input2.default, { disabled: true }))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5DE5\u5E8F\u53F7' }, formItemLayout),
            getFieldDecorator('process_id')(_react2.default.createElement(_input2.default, { disabled: true }))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5206\u914D\u7EC4' }, formItemLayout),
            getFieldDecorator('work_group_name')(_react2.default.createElement(_CustomSelect2.default, { placeholder: '\u8BF7\u9009\u62E9\u5206\u914D\u7684\u5DE5\u4F5C\u7EC4', list: this.state.groups
            }))
          )
        )
      );
...
exports.default = TaskAllocation;
...
var TASK_ALLOCATION_GET_LIST_DATA = 'TASK_ALLOCATION_GET_LIST_DATA';
var TASK_ALLOCATION_ADD_LIST_DATA = 'TASK_ALLOCATION_ADD_LIST_DATA';
var TASK_ALLOCATION_CHANGE_MODAL_DATA = 'TASK_ALLOCATION_CHANGE_MODAL_DATA';
var PAGE_SIZE = 10;
...
function TaskAllocation() {
  ...
  var map = {
    TASK_ALLOCATION_GET_LIST_DATA: function TASK_ALLOCATION_GET_LIST_DATA() {
    ...
    TASK_ALLOCATION_ADD_LIST_DATA: function TASK_ALLOCATION_ADD_LIST_DATA() {
    ...
    TASK_ALLOCATION_CHANGE_MODAL_DATA: function TASK_ALLOCATION_CHANGE_MODAL_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(TASK_ALLOCATION_GET_LIST_DATA);
