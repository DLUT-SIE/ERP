...
var _modules = __webpack_require__(923);

var _CompDepartment = __webpack_require__(1515);

var _CompDepartment2 = _interopRequireDefault(_CompDepartment);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CompDepartment2.default));
...
var _FilterBar = __webpack_require__(1516);
...
var _HandleItem = __webpack_require__(1517);

var _HandleItem2 = _interopRequireDefault(_HandleItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['sub_order', 'sketch', 'pressure_test', 'process_lib', 'product_graph', 'encasement_graph', 'shipping_mark', 'encasement_list', 'coating_detail'];

var CompDepartment = function (_React$Component) {
  (0, _inherits3.default)(CompDepartment, _React$Component);

  function CompDepartment(props) {
    (0, _classCallCheck3.default)(this, CompDepartment);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CompDepartment.__proto__ || (0, _getPrototypeOf2.default)(CompDepartment)).call(this, props));
    ...
    _this.handleConfirm = function (fieldsValue) {
      var id = fieldsValue.id,
          type = fieldsValue.type;

      var values = {};
      values[type] = true;
      (0, _api2.default)(_config.apis.ProductionAPI.updateCompDepartmentState, values, { id: id }).then(function (repos) {
    ...
    _this.handleRevoke = function (fieldsValue) {
      var id = fieldsValue.id,
          type = fieldsValue.type;
  ...
  (0, _createClass3.default)(CompDepartment, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      return _utils2.default.buildColumns(columns, {
        sketch: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'sketch', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        pressure_test: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'pressure_test', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        process_lib: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'process_lib', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        product_graph: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'product_graph', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        encasement_graph: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'encasement_graph', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        shipping_mark: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'shipping_mark', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        encasement_list: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'encasement_list', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        },
        coating_detail: {
          render: function render(text, record, index) {
            return _react2.default.createElement(_HandleItem2.default, { type: 'coating_detail', item: record, handleConfirm: _this2.handleConfirm, handleRevoke: _this2.handleRevoke });
          }
        }
      });
    }
...
exports.default = CompDepartment;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          FormItem,
          null,
          getFieldDecorator('sub_order_uid')(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5DE5\u4F5C\u4EE4' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
 ...
 */
var HandleItem = function (_React$Component) {
  (0, _inherits3.default)(HandleItem, _React$Component);

  function HandleItem(props) {
    (0, _classCallCheck3.default)(this, HandleItem);

    var _this = (0, _possibleConstructorReturn3.default)(this, (HandleItem.__proto__ || (0, _getPrototypeOf2.default)(HandleItem)).call(this, props));

    _this.handleRevoke = function (e) {
      var handleRevoke = _this.props.handleRevoke;
    ...
    _this.handleConfirm = function (e) {
      ...
      handleConfirm && handleConfirm((0, _extends3.default)({}, values));
    };

    return _this;
  }

  (0, _createClass3.default)(HandleItem, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          item = _props.item,
      ...
      if (item[type]) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            _button2.default,
            { type: 'success', size: 'small', onClick: this.handleRevoke, 'data-id': item.id, 'data-type': type },
            '\u64A4\u9500'
          )
        );
      } else {
        return _react2.default.createElement(
          _button2.default,
          { onClick: this.handleConfirm, size: 'small', 'data-id': item.id, 'data-type': type },
          '\u786E\u8BA4'
        );
      }
    }
...
HandleItem.propTypes = {
  ...
  handleRevoke: _propTypes2.default.func.isRequired,
  handleConfirm: _propTypes2.default.func.isRequired
};

exports.default = HandleItem;
...
var COMP_DEPARTMENT_GET_LIST_DATA = 'COMP_DEPARTMENT_GET_LIST_DATA';
var COMP_DEPARTMENT_ADD_LIST_DATA = 'COMP_DEPARTMENT_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function CompDepartment() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    COMP_DEPARTMENT_GET_LIST_DATA: function COMP_DEPARTMENT_GET_LIST_DATA() {
    ...
    COMP_DEPARTMENT_ADD_LIST_DATA: function COMP_DEPARTMENT_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(COMP_DEPARTMENT_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProductionAPI.getCompDepartment, params);
