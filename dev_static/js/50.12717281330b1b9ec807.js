...
var columns = ['production_name', 'send_file'];
        ...
        send_file: {
          children: [{
            ...
            render: function render(text, record, index) {
              var document = record.documents_from_distribution['production'];
            ...
            width: 60,
            render: function render(text, record, index) {
              var data = { product: record.id, dst: deptMap['production'], src: deptMap['distribution'] };
              return _react2.default.createElement(
                _upload2.default,
                {
                  name: 'file',
            ...
            width: 250,
            render: function render(text, record, index) {
              var document = record.documents_from_distribution['process'];
              return document ? _react2.default.createElement(
                'a',
                {
                  className: 'document-link',
            ...
            width: 60,
            render: function render(text, record, index) {
              var data = { product: record.id, dst: deptMap['process'], src: deptMap['distribution'] };
              return _react2.default.createElement(
                _upload2.default,
                {
                  name: 'file',
            ...
            colSpan: 2,
            render: function render(text, record, index) {
              var document = record.documents_from_distribution['procurement'];
              return document ? _react2.default.createElement(
                'a',
                {
                  className: 'document-link',
            ...
            width: 60,
            render: function render(text, record, index) {
              var data = { product: record.id, dst: deptMap['procurement'], src: deptMap['distribution'] };
              return _react2.default.createElement(
                _upload2.default,
                {
                  name: 'file',
...
var PRODUCTION_GET_LIST_DATA = 'PRODUCTION_GET_LIST_DATA';
var PRODUCTION_ADD_LIST_DATA = 'PRODUCTION_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function Production() {
  ...
  var map = {
    PRODUCTION_GET_LIST_DATA: function PRODUCTION_GET_LIST_DATA() {
    ...
    PRODUCTION_ADD_LIST_DATA: function PRODUCTION_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(PRODUCTION_GET_LIST_DATA);
...
var _modules = __webpack_require__(1424);

var _Production = __webpack_require__(1423);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Production2.default));
