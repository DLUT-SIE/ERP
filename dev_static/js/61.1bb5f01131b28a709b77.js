...
var _modules = __webpack_require__(924);

var _AddApplyCard = __webpack_require__(1518);

var _AddApplyCard2 = _interopRequireDefault(_AddApplyCard);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AddApplyCard2.default));
...
var _FilterBar = __webpack_require__(1519);
...
var columns = ['work_order_uid', 'lib_name', 'spec', 'material_brand', 'quota', 'count'];
var mapRequest = {
  welding_material_apply_cards: _config.apis.ProductionAPI.createWeldingMaterialApplyCards,
  steel_material_apply_cards: _config.apis.ProductionAPI.createSteelMaterialApplyCards,
  bought_in_component_apply_cards: _config.apis.ProductionAPI.createBroughtInMaterialApplyCards,
  auxiliary_material_apply_cards: _config.apis.ProductionAPI.createAuxiliaryMaterialApplyCards
};

var AddApplyCard = function (_React$Component) {
  (0, _inherits3.default)(AddApplyCard, _React$Component);

  function AddApplyCard(props) {
    (0, _classCallCheck3.default)(this, AddApplyCard);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddApplyCard.__proto__ || (0, _getPrototypeOf2.default)(AddApplyCard)).call(this, props));
    ...
    _this.createApplyCard = function (category, subOrder, processMaterials) {
      var api = mapRequest[category];
      var values = {
        sub_order: subOrder,
        process_materials: processMaterials
      };
      console.log(processMaterials);
      console.log(typeof subOrder === 'undefined' ? 'undefined' : (0, _typeof3.default)(subOrder), (0, _typeof3.default)(processMaterials[0]));
      (0, _api2.default)(api, values).then(function (repos) {
        _message3.default.success('添加成功！');
      });
    };

    _this.handleAddRecords = function (fieldsValue) {
      var apply_card_type = fieldsValue.apply_card_type;
      var status = _this.props.status;

      var mydata = status.toJS();
      var list = _lodash2.default.get(mydata, 'list', []);
      var workOrderId = void 0;
      console.log(list);
      if (list.length > 0) {
        workOrderId = list[0].work_order_id;
      }
      console.log(workOrderId);
      var lists = _this.state.addLists.map(function (item) {
        return parseInt(item);
      });
      workOrderId = parseInt(workOrderId);
      _this.createApplyCard(apply_card_type, workOrderId, lists);
      console.log('addLists', _this.state.addLists, 'location.search', _queryString2.default.parse(location.search));
    ...
    _this.rowSelection = {
      onChange: function onChange(selectedRowKeys, selectedRows) {
        _this.setState({ addLists: selectedRowKeys });
  ...
  (0, _createClass3.default)(AddApplyCard, [{
    key: 'buildColumns',
...
var FilterBar = function (_React$Component) {
  ...
  function FilterBar(props) {
    ...
    _this.handleAddApplyCards = function (e) {
      e.preventDefault();
      var _this$props = _this.props,
          onAddClick = _this$props.onAddClick,
          form = _this$props.form;

      form.validateFields(function () {
        var fieldsValue = form.getFieldsValue();
        onAddClick && onAddClick((0, _extends3.default)({}, fieldsValue));
      });
    };
    ...
    _this.handleDetailChange = function (value) {
      _this.setState({
    ...
    _this.handleApplyCardTypeChange = function (value) {
      _this.setState({
        apply_card: value
      });
    };
    ...
    _this.state = {
      apply_types: applyCardsType[_const.DETAILED_TYPE[0].value] };
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          })(_react2.default.createElement(_input2.default, { className: 'input', placeholder: '\u5DE5\u4F5C\u4EE4' }))
        ),
        _react2.default.createElement(
          FormItem,
          null,
...
var ADD_APPLY_CARD_GET_LIST_DATA = 'ADD_APPLY_CARD_GET_LIST_DATA';
var ADD_APPLY_CARD_ADD_LIST_DATA = 'ADD_APPLY_CARD_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function AddApplyCard() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  var map = {
    ADD_APPLY_CARD_GET_LIST_DATA: function ADD_APPLY_CARD_GET_LIST_DATA() {
    ...
    ADD_APPLY_CARD_ADD_LIST_DATA: function ADD_APPLY_CARD_ADD_LIST_DATA() {
...
// ------------------------------------
var mapRequest = {
  '4': _config.apis.ProductionAPI.getWeldingQuotaItems,
  '1': _config.apis.ProductionAPI.getAuxiliaryQuotaItems,
  '3': _config.apis.ProductionAPI.getBroughtInItems
};
function getListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, detailType, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(ADD_APPLY_CARD_GET_LIST_DATA);
        ...
        case 3:
          ...
          detailType = mapRequest[params.detail_type];

          console.log('params', params);
          if (_lodash2.default.isUndefined(detailType)) {
            detailType = _config.apis.ProductionAPI.getWeldingQuotaItems;
          }
          _context.next = 12;
          return (0, _effects.call)(_api2.default, detailType, params);
