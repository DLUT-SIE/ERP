...
var _modules = __webpack_require__(918);

var _TransferCard = __webpack_require__(1497);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TransferCard2.default));
...
var _TableInfo = __webpack_require__(1496);

var _TableInfo2 = _interopRequireDefault(_TableInfo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var columns = ['ticket_number', 'part_name', 'transfer_card_category', 'file_index', 'write_status', 'action'];

var TransferCard = function (_React$Component) {
  (0, _inherits3.default)(TransferCard, _React$Component);

  function TransferCard(props) {
    (0, _classCallCheck3.default)(this, TransferCard);

    var _this = (0, _possibleConstructorReturn3.default)(this, (TransferCard.__proto__ || (0, _getPrototypeOf2.default)(TransferCard)).call(this, props));

    _this.handleDelete = function (id) {
      return function (e) {
        (0, _api2.default)(_config.apis.ProcessAPI.deleteTransferCard, {}, { id: id }).then(function (repos) {
    ...
    _this._workOrderInfo = _queryString2.default.parse(_this.props.location.search);
    return _this;
  }

  (0, _createClass3.default)(TransferCard, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { to: '/process/process/transfer_card/transfer_card_detail/?id=' + record.id + '&category=' + record.category },
                  '\u67E5\u770B'
                )
              ),
    ...
    value: function render() {
      ...
      var workOrderInfo = this._workOrderInfo;
      return _react2.default.createElement(
        'div',
        null,
...
var TRANSFER_GET_LIST_DATA = 'TRANSFER_GET_LIST_DATA';
var TRANSFER_ADD_LIST_DATA = 'TRANSFER_ADD_LIST_DATA';
...
function TransferCard() {
  ...
  var map = {
    TRANSFER_GET_LIST_DATA: function TRANSFER_GET_LIST_DATA() {
      return state.set('loading', true);
    },
    TRANSFER_ADD_LIST_DATA: function TRANSFER_ADD_LIST_DATA() {
      var data = action.payload.data;
      var results = data.results,
          workOrder = data.work_order_uid,
          productionName = data.name,
          unit = data.unit;

      return state.mergeIn(['workOrderInfo'], {
        workOrder: workOrder,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(TRANSFER_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getTransferCards, params);
