...
var _modules = __webpack_require__(917);

var _ProcessImport = __webpack_require__(1495);

var _ProcessImport2 = _interopRequireDefault(_ProcessImport);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ProcessImport2.default));
...
var columns = ['work_order_uid', 'production_name', 'action'];
...
var ProcessImport = function (_React$Component) {
  ...
  function ProcessImport(props) {
    ...
    _this.uploadFile = function (file) {
      (0, _api2.default)(_config.apis.ProcessAPI.uploadProcessLibrary, (0, _extends3.default)({
        file: file.file
      }, file.data), {}, true).then(function () {
        _message3.default.success('上传成功');
        _this.updatelist();
      });
    };

    _this.handleProof = function (e) {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { to: '/process/process/?work_order_uid=' + record.work_order_uid },
                  '\u67E5 \u770B'
                )
              ),
              ...
              _react2.default.createElement(
                _upload2.default,
                {
                  ...
                  data: { id: record.id },
                  customRequest: _this2.uploadFile
                },
                _react2.default.createElement(
                  _button2.default,
                  {
...
var IMPORT_GET_LIST_DATA = 'IMPORT_GET_LIST_DATA';
var IMPORT_ADD_LIST_DATA = 'IMPORT_ADD_LIST_DATA';
var PAGE_SIZE = 10;
...
function ProcessImport() {
  ...
  var map = {
    IMPORT_GET_LIST_DATA: function IMPORT_GET_LIST_DATA() {
    ...
    IMPORT_ADD_LIST_DATA: function IMPORT_ADD_LIST_DATA() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(IMPORT_GET_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.ProcessAPI.getProcessLibraries, params);
