...
var _WorkOrderModal = __webpack_require__(1421);

var _WorkOrderModal2 = _interopRequireDefault(_WorkOrderModal);

var _CheckModal = __webpack_require__(1420);
...
var productionColumns = ['production_name', 'upload_file', 'create_work_order'];
var workOrderColumns = ['uid', 'pretty_sell_type', 'client', 'project', 'count'];

var BidDocument = function (_React$Component) {
  (0, _inherits3.default)(BidDocument, _React$Component);

  function BidDocument(props) {
    (0, _classCallCheck3.default)(this, BidDocument);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BidDocument.__proto__ || (0, _getPrototypeOf2.default)(BidDocument)).call(this, props));

    _this.handleChangeProductionTable = function (pagination, filters, sorter) {
      var query = _this.updateQuery({
        page1: pagination.current > 1 ? pagination.current : ''
      }, 'page1');
      _this.fetchProductionList(query, 'page1');
    };

    _this.handleChangeWorkOrderTable = function (pagination, filters, sorter) {
      var query = _this.updateQuery({
        page2: pagination.current > 1 ? pagination.current : ''
      }, 'page2');
      _this.fetchWorkOrderList(query, 'page2');
    };

    _this.handleOpenCheckModal = function (e) {
      var id = +e.target.dataset.id;
      var map = JSON.parse(e.target.dataset.map);
      var checkList = _lodash2.default.map(map, function (value, key) {
        return {
          value: value,
          label: key
        };
      });
      _this.props.changeCheckModalAction({
        visible: true,
        documentId: id,
        checkList: checkList
      });
    ...
    _this.handleOpenWorkOrderModal = function (e) {
      var id = +e.target.dataset.id;
      _this.props.changeWorkOrderModalAction({
        visible: true,
        productionId: id
      });
    };

    _this.handleCloseCheckModal = function () {
      _this.props.changeCheckModalAction({
        visible: false
      });
    };

    _this.handleCloseWorkOrderModal = function () {
      _this.props.changeWorkOrderModalAction({
        visible: false
      });
    };

    _this.handleSaveCheck = function (values) {
      (0, _api2.default)(_config.apis.DistributionAPI.saveCheckDocument, values.fieldsValue, { id: values.id }).then(function (repos) {
        _message4.default.success('审核成功！');
        _this.handleCloseCheckModal();
        _this.fetchProductionList(_this._query({}, 'page1'));
      });
    };

    _this.handleSaveWorkOrder = function (fieldsValue) {
      (0, _api2.default)(_config.apis.DistributionAPI.saveWorkOrder, fieldsValue).then(function (repos) {
        if (repos.id !== undefined) {
          _message4.default.success('工作令生成成功！');
          _this.handleCloseWorkOrderModal();
          _this.fetchProductionList(_this._query({}, 'page1'));
          _this.fetchWorkOrderList(_this._query({}, 'page2'));
        }
      });
    };

    _this._productionColumns = _this.buildProductionColumns();
    _this._workOrderColumns = _this.buildWorkOrderColumns();
    return _this;
  }

  (0, _createClass3.default)(BidDocument, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    key: 'fetchProductionList',
    value: function fetchProductionList(query) {
    ...
    key: 'fetchWorkOrderList',
    value: function fetchWorkOrderList(query) {
    ...
    key: 'buildProductionColumns',
    value: function buildProductionColumns() {
      var _this2 = this;

      return _utils2.default.buildColumns(productionColumns, {
        name: {
          width: 220,
          fixed: 'left'
        },
        upload_file: {
          children: [{
            ...
            render: function render(text, record, index) {
              var document = record.documents_to_distribution['production'];
              return document ? _react2.default.createElement(
                'a',
                {
            ...
            render: function render(text, record, index) {
              ...
              return document.actions.status ? _react2.default.createElement(
                _button2.default,
                {
                  type: 'primary',
                  size: 'small',
                  'data-id': document.id,
                  'data-map': (0, _stringify2.default)(document.actions.status),
                  onClick: _this2.handleOpenCheckModal
                },
                '\u5BA1\u6838'
            ...
            width: 220,
            render: function render(text, record, index) {
              var document = record.documents_to_distribution['process'];
              return document ? _react2.default.createElement(
                'a',
                {
                  className: 'document-link',
            ...
            width: 220,
            render: function render(text, record, index) {
              var document = record.documents_to_distribution['procurement'];
              return document ? _react2.default.createElement(
                'a',
                {
                  className: 'document-link',
        ...
        create_work_order: {
          render: function render(text, record, index) {
            var abled = _lodash2.default.every(record.documents_to_distribution, function (value, key) {
            ...
            return _react2.default.createElement(
              _button2.default,
              {
                ...
                size: 'small',
                'data-id': record.id,
                onClick: _this2.handleOpenWorkOrderModal,
                disabled: !abled
              },
              '\u751F\u6210\u5DE5\u4F5C\u4EE4'
            );
    ...
    key: 'buildWorkOrderColumns',
    value: function buildWorkOrderColumns() {
      return _utils2.default.buildColumns(workOrderColumns, {});
    }
  }, {
    key: '_query',
    value: function _query() {
      ...
      return (0, _assign2.default)((0, _defineProperty3.default)({}, page, 1), oldQuery, query);
    }
  }, {
    key: 'updateQuery',
    value: function updateQuery() {
      ...
      var mergeQuery = this._query(newQuery, page);
    ...
    value: function render() {
      ...
      var productionList = _lodash2.default.get(mydata, 'productionList', []);
      var productionLoading = _lodash2.default.get(mydata, 'productionLoading');
      var productionPagination = _lodash2.default.get(mydata, 'productionPagination', {});
      var workOrderList = _lodash2.default.get(mydata, 'workOrderList', []);
      var workOrderLoading = _lodash2.default.get(mydata, 'workOrderLoading');
      var workOrderPagination = _lodash2.default.get(mydata, 'workOrderPagination', {});
      var checkModal = _lodash2.default.get(mydata, 'checkModal', {});
      var workOrderModal = _lodash2.default.get(mydata, 'workOrderModal', {});
      return _react2.default.createElement(
        'div',
        { className: 'bid-document' },
        ...
        workOrderModal.visible && _react2.default.createElement(_WorkOrderModal2.default, (0, _extends3.default)({}, workOrderModal, {
          onOk: this.handleSaveWorkOrder,
          onCancel: this.handleCloseWorkOrderModal
        })),
        checkModal.visible && _react2.default.createElement(_CheckModal2.default, (0, _extends3.default)({}, checkModal, {
...
BidDocument.propTypes = {
  ...
  getProductionListDataAction: _propTypes2.default.func.isRequired,
  getWorkOrderListDataAction: _propTypes2.default.func.isRequired,
  changeCheckModalAction: _propTypes2.default.func.isRequired,
  changeWorkOrderModalAction: _propTypes2.default.func.isRequired
};

exports.default = BidDocument;
...
var CheckModal = function (_React$Component) {
  (0, _inherits3.default)(CheckModal, _React$Component);

  function CheckModal(props) {
    (0, _classCallCheck3.default)(this, CheckModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CheckModal.__proto__ || (0, _getPrototypeOf2.default)(CheckModal)).call(this, props));
  ...
  (0, _createClass3.default)(CheckModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5BA1\u6838' }, formItemLayout),
            form.getFieldDecorator('status', fieldsConfig['status'])(_react2.default.createElement(_CustomSelect2.default, {
              placeholder: '----',
              list: checkList
            }))
          )
...
CheckModal.propTypes = {
  ...
  documentId: _propTypes2.default.number.isRequired,
...
var WrappedForm = _form2.default.create({})(CheckModal);
...
var WorkOrderModal = function (_React$Component) {
  (0, _inherits3.default)(WorkOrderModal, _React$Component);

  function WorkOrderModal(props) {
    (0, _classCallCheck3.default)(this, WorkOrderModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WorkOrderModal.__proto__ || (0, _getPrototypeOf2.default)(WorkOrderModal)).call(this, props));
  ...
  (0, _createClass3.default)(WorkOrderModal, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          visible = _props.visible,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5DE5\u4F5C\u4EE4\u7F16\u53F7' }, formItemLayout),
            form.getFieldDecorator('uid', fieldsConfig['id'])(_react2.default.createElement(_input2.default, null))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u9500\u552E\u7C7B\u578B' }, formItemLayout),
            form.getFieldDecorator('sell_type', fieldsConfig['sell_type'])(_react2.default.createElement(_CustomSelect2.default, {
              placeholder: '----',
              list: _const.SELL_TYPE_LIST
            }))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u5BA2\u6237\u540D\u79F0' }, formItemLayout),
            form.getFieldDecorator('client', fieldsConfig['client'])(_react2.default.createElement(_input2.default, null))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u9879\u76EE\u540D\u79F0' }, formItemLayout),
            form.getFieldDecorator('project', fieldsConfig['project_name'])(_react2.default.createElement(_input2.default, null))
          ),
          _react2.default.createElement(
            FormItem,
            (0, _extends3.default)({ label: '\u6570\u91CF' }, formItemLayout),
            form.getFieldDecorator('count', fieldsConfig['count'])(_react2.default.createElement(_input2.default, null))
          )
        )
      );
    }
...
WorkOrderModal.propTypes = {
  visible: _propTypes2.default.bool.isRequired,
  productionId: _propTypes2.default.number.isRequired,
  onOk: _propTypes2.default.func,
  onCancel: _propTypes2.default.func,
  form: _propTypes2.default.object
};
...
exports.getProductionListSaga = getProductionListSaga;
exports.getWorkOrderListSaga = getWorkOrderListSaga;
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(getProductionListSaga),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(getWorkOrderListSaga);

// ------------------------------------
// Constants
// ------------------------------------

var BIDDOCUMENT_GET_PRODUCTION_LIST_DATA = 'BIDDOCUMENT_GET_PRODUCTION_LIST_DATA';
var BIDDOCUMENT_ADD_PRODUCTION_LIST_DATA = 'BIDDOCUMENT_ADD_PRODUCTION_LIST_DATA';
var BIDDOCUMENT_GET_WORKORDER_LIST_DATA = 'BIDDOCUMENT_GET_WORKORDER_LIST_DATA';
var BIDDOCUMENT_ADD_WORKORDER_LIST_DATA = 'BIDDOCUMENT_ADD_WORKORDER_LIST_DATA';
var BIDDOCUMENT_CHANGE_CHECK_MODAL_DATA = 'BIDDOCUMENT_CHANGE_CHECK_MODAL_DATA';
var BIDDOCUMENT_CHANGE_WORK_ORDER_MODAL_DATA = 'BIDDOCUMENT_CHANGE_WORK_ORDER_MODAL_DATA';
var PAGE_SIZE = 10;
...
function addProductionListDataAction() {
...
function addWorkOrderListDataAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function changeCheckModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function changeWorkOrderModalAction() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var actions = exports.actions = {
  getProductionListDataAction: getProductionListDataAction,
  getWorkOrderListDataAction: getWorkOrderListDataAction,
  changeCheckModalAction: changeCheckModalAction,
  changeWorkOrderModalAction: changeWorkOrderModalAction
...
function Production() {
  ...
  var map = {
    BIDDOCUMENT_GET_PRODUCTION_LIST_DATA: function BIDDOCUMENT_GET_PRODUCTION_LIST_DATA() {
      var _action$payload$param = action.payload.params,
          params = _action$payload$param === undefined ? {} : _action$payload$param;

      return state.mergeIn(['productionPagination'], {
        current: +(params.page || 1),
        pageSize: +(params.limit || PAGE_SIZE)
      }).set('productionLoading', true);
    },
    BIDDOCUMENT_ADD_PRODUCTION_LIST_DATA: function BIDDOCUMENT_ADD_PRODUCTION_LIST_DATA() {
      var data = action.payload.data;

      return state.mergeIn(['productionPagination'], { total: data.count }).merge({
        productionList: data.results,
        productionLoading: false
      });
    },
    BIDDOCUMENT_GET_WORKORDER_LIST_DATA: function BIDDOCUMENT_GET_WORKORDER_LIST_DATA() {
      var _action$payload$param2 = action.payload.params,
          params = _action$payload$param2 === undefined ? {} : _action$payload$param2;

      return state.mergeIn(['workOrderPagination'], {
        current: +(params.page || 1),
        pageSize: +(params.limit || PAGE_SIZE)
      }).set('workOrderLoading', true);
    },
    BIDDOCUMENT_ADD_WORKORDER_LIST_DATA: function BIDDOCUMENT_ADD_WORKORDER_LIST_DATA() {
      var data = action.payload.data;

      return state.mergeIn(['workOrderPagination'], { total: data.count }).merge({
        workOrderList: data.results,
        workOrderLoading: false
      });
    },
    BIDDOCUMENT_CHANGE_CHECK_MODAL_DATA: function BIDDOCUMENT_CHANGE_CHECK_MODAL_DATA() {
      return state.mergeIn(['checkModal'], action.payload);
    },
    BIDDOCUMENT_CHANGE_WORK_ORDER_MODAL_DATA: function BIDDOCUMENT_CHANGE_WORK_ORDER_MODAL_DATA() {
...
function getProductionListSaga(type, body) {
  var _ref, _ref$payload, payload, callback, params, data;

  return _regenerator2.default.wrap(function getProductionListSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _effects.take)(BIDDOCUMENT_GET_PRODUCTION_LIST_DATA);
        ...
        case 3:
          ...
          _context.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.DistributionAPI.getProFileList, params);
        ...
        case 9:
          ...
          callback && callback();
          _context.next = 13;
          return (0, _effects.put)(addProductionListDataAction({ data: data }));
...
function getWorkOrderListSaga(type, body) {
  var _ref2, _ref2$payload, _payload, _callback, _params, data;

  return _regenerator2.default.wrap(function getWorkOrderListSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _effects.take)(BIDDOCUMENT_GET_WORKORDER_LIST_DATA);
        ...
        case 3:
          ...
          _context2.next = 9;
          return (0, _effects.call)(_api2.default, _config.apis.DistributionAPI.getWorkOrderList, _params);
        ...
        case 9:
          ...
          _callback && _callback();
          _context2.next = 13;
          return (0, _effects.put)(addWorkOrderListDataAction({ data: data }));
...
var sagas = exports.sagas = [getProductionListSaga, getWorkOrderListSaga];
...
var _modules = __webpack_require__(884);

var _BidDocument = __webpack_require__(1419);

var _BidDocument2 = _interopRequireDefault(_BidDocument);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_BidDocument2.default));
